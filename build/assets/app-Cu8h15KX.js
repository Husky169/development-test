        ...
        if (typeof Kr != "string" && !Array.isArray(Kr)) {
            for (const Yr in Kr)
                if (Yr !== "default" && !(Yr in ze)) {
                    ...
                    Qr && Object.defineProperty(ze, Yr, Qr.get ? Qr : {
                        enumerable: !0,
                        get: () => Kr[Yr]
                    })
                }
        ...
        return function() {
            var Q = {
                ...
                createWebSocket: function(ze) {
                    ...
                    return Gr.binaryType = Q.config.wsBinaryType,
                    Gr
                },
                version: "1.9.12"
            }
            ...
            function d(ze) {
                if (ze == null)
                    return;
                let Gr = NaN;
                return ze.slice(-2) == "ms" ? Gr = parseFloat(ze.slice(0, -2)) : ze.slice(-1) == "s" ? Gr = parseFloat(ze.slice(0, -1)) * 1e3 : ze.slice(-1) == "m" ? Gr = parseFloat(ze.slice(0, -1)) * 1e3 * 60 : Gr = parseFloat(ze),
                isNaN(Gr) ? void 0 : Gr
            }
            function ee(ze, Gr) {
            ...
            function s(ze, Gr) {
                for (var Wr = new DOMParser, Kr = Wr.parseFromString(ze, "text/html"), Yr = Kr.body; Gr > 0; )
                    Gr--,
                    Yr = Yr.firstChild;
                return Yr == null && (Yr = re().createDocumentFragment()),
                Yr
            }
            function N(ze) {
                return /<body/.test(ze)
            ...
            function l(ze) {
                var Gr = !N(ze)
                  , Wr = A(ze)
                  , Kr = ze;
                if (Wr === "head" && (Kr = Kr.replace(S, "")),
                Q.config.useTemplateFragments && Gr) {
            ...
            function le(ze, Gr) {
                for (var Wr in Gr)
                    Gr.hasOwnProperty(Wr) && (ze[Wr] = Gr[Wr]);
                return ze
            }
            function E(ze) {
                try {
            ...
            function B(ze) {
                try {
                    var Gr = new URL(ze);
                    return Gr && (ze = Gr.pathname + Gr.search),
            ...
            function _(ze, Gr) {
                ...
                Gr ? setTimeout(function() {
                    _(ze),
                    ze = null
                }, Gr) : ze.parentElement.removeChild(ze)
            }
            function z(ze, Gr, Wr) {
                ze = p(ze),
                Wr ? setTimeout(function() {
                    z(ze, Gr),
                    ze = null
                }, Wr) : ze.classList && ze.classList.add(Gr)
            }
            function n(ze, Gr, Wr) {
                ze = p(ze),
                Wr ? setTimeout(function() {
                    n(ze, Gr),
                    ze = null
                }, Wr) : ze.classList && (ze.classList.remove(Gr),
                ze.classList.length === 0 && ze.removeAttribute("class"))
            }
            function $(ze, Gr) {
                ze = p(ze),
                ze.classList.toggle(Gr)
            }
            function W(ze, Gr) {
                ze = p(ze),
            ...
            function Z(ze, Gr) {
                return Gr.indexOf("closest ") === 0 ? [v(ze, J(Gr.substr(8)))] : Gr.indexOf("find ") === 0 ? [C(ze, J(Gr.substr(5)))] : Gr === "next" ? [ze.nextElementSibling] : Gr.indexOf("next ") === 0 ? [K(ze, J(Gr.substr(5)))] : Gr === "previous" ? [ze.previousElementSibling] : Gr.indexOf("previous ") === 0 ? [Y(ze, J(Gr.substr(9)))] : Gr === "document" ? [document] : Gr === "window" ? [window] : Gr === "body" ? [document.body] : re().querySelectorAll(J(Gr))
            }
            ...
            function me(ze, Gr) {
                ...
                if (Wr) {
                    if (Wr === "this")
                        return [xe(ze, Gr)];
                    var Kr = Z(ze, Wr);
                    return Kr.length === 0 ? (b('The selector "' + Wr + '" on ' + Gr + " returned no matches!"),
                    [pe]) : Kr
                }
            }
            function xe(ze, Gr) {
            ...
            function ye(ze) {
                ...
                if (Gr)
                    return Gr === "this" ? xe(ze, "hx-target") : ue(ze, Gr);
                var Wr = ae(ze);
                return Wr.boosted ? re().body : ze
            }
            function be(ze) {
                for (var Gr = Q.config.attributesToSettle, Wr = 0; Wr < Gr.length; Wr++)
                    if (ze === Gr[Wr])
                        return !0;
                return !1
            }
            ...
            function Ee(ze, Gr, Wr) {
                var Kr = "#" + ee(Gr, "id")
                  , Yr = "outerHTML";
                ze === "true" || (ze.indexOf(":") > 0 ? (Yr = ze.substr(0, ze.indexOf(":")),
                Kr = ze.substr(ze.indexOf(":") + 1, ze.length)) : Yr = ze);
                var Qr = re().querySelectorAll(Kr);
                return Qr ? (oe(Qr, function(Jr) {
                    var Zr, ei = Gr.cloneNode(!0);
                ...
                Gr.parentNode.removeChild(Gr)) : (Gr.parentNode.removeChild(Gr),
            ...
            function a(ze, Gr, Wr, Kr) {
                for (Te(ze, Wr, Kr); Wr.childNodes.length > 0; ) {
                    ...
                    z(Yr, Q.config.addedClass),
                    ze.insertBefore(Yr, Gr),
                    Yr.nodeType !== Node.TEXT_NODE && Yr.nodeType !== Node.COMMENT_NODE && Kr.tasks.push(Oe(Yr))
                }
            }
            function He(ze, Gr) {
                for (var Wr = 0; Wr < ze.length; )
                    Gr = (Gr << 5) - Gr + ze.charCodeAt(Wr++) | 0;
                return Gr
            }
            function Le(ze) {
                var Gr = 0;
            ...
            function Ne(ze) {
                ...
                Gr.listenerInfos && oe(Gr.listenerInfos, function(Wr) {
            ...
            function m(ze) {
                ...
                Ne(ze),
                ze.children && oe(ze.children, function(Gr) {
                    m(Gr)
                })
            }
            function Ie(ze, Gr, Wr) {
                if (ze.tagName === "BODY")
                    return Ue(ze, Gr, Wr);
                var Kr, Yr = ze.previousSibling;
                for (a(u(ze), ze, Gr, Wr),
                Yr == null ? Kr = u(ze).firstChild : Kr = Yr.nextSibling,
                Wr.elts = Wr.elts.filter(function(Qr) {
                    return Qr != ze
                }); Kr && Kr !== ze; )
                    Kr.nodeType === Node.ELEMENT_NODE && Wr.elts.push(Kr),
                    Kr = Kr.nextElementSibling;
                m(ze),
                u(ze).removeChild(ze)
            }
            ...
            function _e(ze, Gr, Wr) {
                ...
                if (Kr.indexOf("{") === 0) {
                    ...
                    for (var Zr = Kr.split(","), ei = 0; ei < Zr.length; ei++)
                        ce(Wr, Zr[ei].trim(), [])
            }
            var x = /[\s,]/
              , $e = /[_$a-zA-Z]/
            ...
            function Ye(ze) {
                for (var Gr = [], Wr = 0; Wr < ze.length; ) {
                    if ($e.exec(ze.charAt(Wr))) {
                        for (var Kr = Wr; We.exec(ze.charAt(Wr + 1)); )
                            Wr++;
                ...
                if (Gr[0] === "[") {
                    ...
                    for (var Kr = 1, Yr = " return (function(" + Wr + "){ return (", Qr = null; Gr.length > 0; ) {
                        ...
                        if (Jr === "]") {
                            ...
                            Jr === "[" && Kr++;
                        Qe(Jr, Qr, Wr) ? Yr += "((" + Wr + "." + Jr + ") ? (" + Wr + "." + Jr + ") : (window." + Jr + "))" : Yr = Yr + Jr,
                        Qr = Gr.shift()
                    }
                }
            }
            function y(ze, Gr) {
                for (var Wr = ""; ze.length > 0 && !Gr.test(ze[0]); )
                    Wr += ze.shift();
                return Wr
            }
            function tt(ze) {
                        ...
                        if (Jr === "every") {
                            ...
                            for (ei && (ti.eventFilter = ei); Yr.length > 0 && Yr[0] !== ","; ) {
                                ...
                                if (ri === "changed")
                                    ...
                                    ri === "target" && Yr[0] === ":" ? (Yr.shift(),
                                    ti.target = tt(Yr)) : ri === "throttle" && Yr[0] === ":" ? (Yr.shift(),
                                    ti.throttle = d(y(Yr, x))) : ri === "queue" && Yr[0] === ":" ? (Yr.shift(),
                                    ti.queue = y(Yr, x)) : ri === "root" && Yr[0] === ":" ? (Yr.shift(),
                                    ti[ri] = tt(Yr)) : ri === "threshold" && Yr[0] === ":" ? (Yr.shift(),
                                    ti[ri] = y(Yr, x)) : fe(ze, "htmx:syntax:error", {
                                        token: Yr.shift()
                                    })
                            }
                            Kr.push(ti)
                        }
                    Yr.length === Qr && fe(ze, "htmx:syntax:error", {
                        token: Yr.shift()
                    }),
                    y(Yr, Je)
                } while (Yr[0] === "," && Yr.shift());
            ...
            function it(ze) {
                ...
                return Wr.length > 0 ? Wr : h(ze, "form") ? [{
                    trigger: "submit"
            ...
            function ot(ze, Gr, Wr) {
                ...
                Kr.timeout = setTimeout(function() {
                    se(ze) && Kr.cancelled !== !0 && (ct(Wr, ze, Wt("hx:poll:trigger", {
                        triggerSpec: Wr,
                        target: ze
                    })) || Gr(ze),
                    ot(ze, Gr, Wr))
            ...
            function ut(ze, Gr) {
                return !!((ze.type === "submit" || ze.type === "click") && (Gr.tagName === "FORM" || h(Gr, 'input[type="submit"], button') && v(Gr, "form") !== null || Gr.tagName === "A" && Gr.href && (Gr.getAttribute("href") === "#" || Gr.getAttribute("href").indexOf("#") !== 0)))
            }
            function ft(ze, Gr) {
            ...
            function ht(ze, Gr, Wr, Kr, Yr) {
                ...
                Kr.changed && Jr.forEach(function(Zr) {
                    var ei = ae(Zr);
                ...
                oe(Jr, function(Zr) {
                    var ei = function(ti) {
                        ...
                        if (!ft(ze, ti) && ((Yr || ut(ti, ze)) && ti.preventDefault(),
                        !ct(Kr, ze, ti))) {
                            var ri = ae(ti);
                            if (ri.triggerSpec = Kr,
                            ri.handledFor == null && (ri.handledFor = []),
                            ri.handledFor.indexOf(ze) < 0) {
                                if (ri.handledFor.push(ze),
                                Kr.consume && ti.stopPropagation(),
                                Kr.target && ti.target && !h(ti.target, Kr.target))
                                    return;
                                if (Kr.once) {
                                    if (Qr.triggeredOnce)
                                        return;
                                ...
                                Qr.throttle)
                                    return;
                                Kr.throttle > 0 ? Qr.throttle || (Gr(ze, ti),
                                Qr.throttle = setTimeout(function() {
                                    Qr.throttle = null
                                }, Kr.throttle)) : Kr.delay > 0 ? Qr.delayed = setTimeout(function() {
                                    Gr(ze, ti)
                                }, Kr.delay) : (ce(ze, "htmx:trigger"),
                                Gr(ze, ti))
                            }
                        }
                    };
                    Wr.listenerInfos == null && (Wr.listenerInfos = []),
                    Wr.listenerInfos.push({
                        trigger: Kr.trigger,
                        listener: ei,
                        on: Zr
                    }),
                    Zr.addEventListener(Kr.trigger, ei)
                })
            }
            var vt = !1
              , dt = null;
            ...
            function pt(ze) {
                if (!o(ze, "data-hx-revealed") && X(ze)) {
                    ...
                    var Gr = ae(ze);
                    Gr.initHash ? ce(ze, "revealed") : ze.addEventListener("htmx:afterProcessNode", function(Wr) {
                        ce(ze, "revealed")
                    }, {
                        once: !0
                    })
            ...
            function bt(ze) {
                ...
                Gr ? ze.addEventListener(it(ze)[0].trigger, function(Wr) {
                    ...
                    Kr.send(JSON.stringify(ri)),
                    ut(Wr, ze) && Wr.preventDefault()
            ...
            function St(ze, Gr, Wr) {
                for (var Kr = D(Wr), Yr = 0; Yr < Kr.length; Yr++) {
                    var Qr = Kr[Yr].split(/:(.+)/);
                    Qr[0] === "connect" && Et(ze, Qr[1]),
                    Qr[0] === "swap" && Ct(ze, Qr[1])
                }
            }
            function Et(ze, Gr) {
                      ...
                      , Yr = function(Qr) {
                        if (!Tt(Wr)) {
                            ...
                            var Zr = wr(ze)
                              , ei = ye(ze)
                              , ti = T(ze);
                            je(Zr.swapStyle, ei, ze, Jr, ti),
                            nr(ti.tasks),
                            ce(ze, "htmx:sseMessage", Qr)
                        }
                    };
                    ae(ze).sseListener = Yr,
                    Kr.addEventListener(Gr, Yr)
                } else
            ...
            function Rt(ze, Gr, Wr) {
                ...
                if (Kr) {
                    ...
                    ae(ze).sseListener = Qr,
                    Yr.addEventListener(Wr, Qr)
                } else
                    fe(ze, "htmx:noSSESourceError")
            }
            function Tt(ze) {
            ...
            function Lt(ze, Gr, Wr, Kr) {
                if (Gr.sseEvent)
                    Rt(ze, Kr, Gr.sseEvent);
                else if (Gr.trigger === "revealed")
                    gt(),
                    ht(ze, Kr, Wr, Gr),
                    pt(ze);
                else if (Gr.trigger === "intersect") {
                    var Yr = {};
                    Gr.root && (Yr.root = ue(ze, Gr.root)),
                    Gr.threshold && (Yr.threshold = parseFloat(Gr.threshold));
                    ...
                    Gr.trigger === "load" ? ct(Gr, ze, Wt("load", {
                        elt: ze
                    })) || qt(ze, Kr, Wr, Gr.delay) : Gr.pollInterval > 0 ? (Wr.polling = !0,
                    ot(ze, Kr, Gr)) : ht(ze, Kr, Wr, Gr)
            }
            function At(ze) {
            ...
            function It(ze) {
                ...
                for (var Wr = 0; Wr < Gr.length; Wr++) {
                    var Kr = Gr[Wr].name;
                    if (g(Kr, "hx-on:") || g(Kr, "data-hx-on:") || g(Kr, "hx-on-") || g(Kr, "data-hx-on-"))
                        return !0
                }
                return !1
            }
            function kt(ze) {
                ...
                document.evaluate)
                    ...
                    for (var Yr = ze.getElementsByTagName("*"), Qr = 0; Qr < Yr.length; Qr++)
                        It(Yr[Qr]) && Wr.push(Yr[Qr]);
                return Wr
            }
            function Pt(ze) {
            ...
            function Ft(ze, Gr, Wr) {
                ...
                var Yr, Qr = function(Jr) {
                    return Tr(ze, function() {
                        Yr || (Yr = new Function("event",Wr)),
                        Yr.call(ze, Jr)
                    })
                };
                ze.addEventListener(Gr, Qr),
                Kr.onHandlers.push({
                    event: Gr,
                    listener: Qr
                })
            ...
            function Vt(ze) {
                var Gr = te(ze, "hx-on");
                if (Gr) {
                    for (var Wr = {}, Kr = Gr.split(`
`), Yr = null, Qr = 0; Kr.length > 0; ) {
                        var Jr = Kr.shift()
            ...
            function _t(ze) {
                ...
                if (Gr.initHash !== Le(ze)) {
                    ...
                    ze.value && (Gr.lastValue = ze.value);
                    var Wr = it(ze)
                      , Kr = Ht(ze, Gr, Wr);
                    Kr || (ne(ze, "hx-boost") === "true" ? lt(ze, Gr, Wr) : o(ze, "hx-trigger") && Wr.forEach(function(Jr) {
            ...
            function Wt(ze, Gr) {
                var Wr;
                return window.CustomEvent && typeof window.CustomEvent == "function" ? Wr = new CustomEvent(ze,{
                    bubbles: !0,
                    cancelable: !0,
                    detail: Gr
                }) : (Wr = re().createEvent("CustomEvent"),
                Wr.initCustomEvent(ze, !0, !0, Gr)),
                Wr
            }
            ...
            function ce(ze, Gr, Wr) {
                ...
                Wr.elt = ze;
                var Kr = Wt(Gr, Wr);
                Q.logger && !Gt(Gr) && Q.logger(ze, Gr, Wr),
                Wr.error && (b(Wr.error),
                ce(ze, "htmx:error", {
                    errorInfo: Wr
                }));
            ...
            function Kt(ze, Gr, Wr, Kr) {
                if (U()) {
                    ...
                    Yr.push(Jr); Yr.length > Q.config.historyCacheSize; )
                        Yr.shift();
                    for (; Yr.length > 0; )
                        try {
            ...
            function Qt(ze) {
                var Gr = Q.config.requestClass
                  , Wr = ze.cloneNode(!0);
                return oe(f(Wr, "." + Gr), function(Kr) {
                    n(Kr, Gr)
                }),
                Wr.innerHTML
            }
            function er() {
                var ze = Zt(), Gr = Jt || location.pathname + location.search, Wr;
                try {
                    Wr = re().querySelector('[hx-history="false" i],[data-hx-history="false" i]')
                } catch {
                    Wr = re().querySelector('[hx-history="false"],[data-hx-history="false"]')
                }
                Wr || (ce(re().body, "htmx:beforeHistorySave", {
                    path: Gr,
                    historyElt: ze
                }),
                Kt(Gr, Qt(ze), re().title, window.scrollY)),
            ...
            function or(ze) {
                ...
                return Gr == null && (Gr = [ze]),
                oe(Gr, function(Wr) {
                    var Kr = ae(Wr);
                    Kr.requestCount = (Kr.requestCount || 0) + 1,
                    Wr.classList.add.call(Wr.classList, Q.config.requestClass)
                }),
                Gr
            }
            function sr(ze) {
            ...
            function lr(ze, Gr) {
                oe(ze, function(Wr) {
                    var Kr = ae(Wr);
                    Kr.requestCount = (Kr.requestCount || 0) - 1,
                    Kr.requestCount === 0 && Wr.classList.remove.call(Wr.classList, Q.config.requestClass)
                }),
                oe(Gr, function(Wr) {
                    var Kr = ae(Wr);
                    Kr.requestCount = (Kr.requestCount || 0) - 1,
                    Kr.requestCount === 0 && Wr.removeAttribute("disabled")
                })
            }
            function ur(ze, Gr) {
                for (var Wr = 0; Wr < ze.length; Wr++) {
            ...
            function hr(ze, Gr, Wr, Kr, Yr) {
                if (!(Kr == null || ur(ze, Kr))) {
                    ...
                    fr(Kr)) {
                        var Qr = ee(Kr, "name")
                          , Jr = Kr.value;
                        Kr.multiple && Kr.tagName === "SELECT" && (Jr = M(Kr.querySelectorAll("option:checked")).map(function(ei) {
                            return ei.value
                        })),
            ...
            function gr(ze, Gr, Wr) {
                ze !== "" && (ze += "&"),
                String(Wr) === "[object Object]" && (Wr = JSON.stringify(Wr));
                var Kr = encodeURIComponent(Wr);
                return ze += encodeURIComponent(Gr) + "=" + Kr,
                ze
            }
            function pr(ze) {
                var Gr = "";
                for (var Wr in ze)
                    if (ze.hasOwnProperty(Wr)) {
                        var Kr = ze[Wr];
                        Array.isArray(Kr) ? oe(Kr, function(Yr) {
                            Gr = gr(Gr, Wr, Yr)
                        }) : Gr = gr(Gr, Wr, Kr)
                    }
                return Gr
            ...
            function xr(ze, Gr, Wr) {
                ...
                return Rr(ze, "hx-headers", !1, Kr),
                Wr !== void 0 && (Kr["HX-Prompt"] = Wr),
                ae(ze).boosted && (Kr["HX-Boosted"] = "true"),
                Kr
            }
            function yr(ze, Gr) {
            ...
            function wr(ze, Gr) {
                ...
                if (Q.config.scrollIntoViewOnBoost && ae(ze).boosted && !br(ze) && (Kr.show = "top"),
                Wr) {
                    var Yr = D(Wr);
                    if (Yr.length > 0)
                        for (var Qr = 0; Qr < Yr.length; Qr++) {
                            ...
                            if (Jr.indexOf("swap:") === 0)
                                Kr.swapDelay = d(Jr.substr(5));
                            else if (Jr.indexOf("settle:") === 0)
                                Kr.settleDelay = d(Jr.substr(7));
                            else if (Jr.indexOf("transition:") === 0)
                                Kr.transition = Jr.substr(11) === "true";
                            else if (Jr.indexOf("ignoreTitle:") === 0)
                                Kr.ignoreTitle = Jr.substr(12) === "true";
                                ...
                                Qr == 0 ? Kr.swapStyle = Jr : b("Unknown modifier in hx-swap: " + Jr)
                        }
                }
                return Kr
            }
            ...
            function Cr(ze, Gr) {
                ...
                if (Gr.scroll) {
                    var Yr = null;
                    Gr.scrollTarget && (Yr = ue(Wr, Gr.scrollTarget)),
                    Gr.scroll === "top" && (Wr || Yr) && (Yr = Yr || Wr,
                    Yr.scrollTop = 0),
                    Gr.scroll === "bottom" && (Kr || Yr) && (Yr = Yr || Kr,
                    Yr.scrollTop = Yr.scrollHeight)
                }
                if (Gr.show) {
                    var Yr = null;
                    if (Gr.showTarget) {
                        var Qr = Gr.showTarget;
                        Gr.showTarget === "window" && (Qr = "body"),
                        Yr = ue(Wr, Qr)
                    }
                    Gr.show === "top" && (Wr || Yr) && (Yr = Yr || Wr,
                    Yr.scrollIntoView({
                        block: "start",
                        behavior: Q.config.scrollBehavior
                    })),
                    Gr.show === "bottom" && (Kr || Yr) && (Yr = Yr || Kr,
                    Yr.scrollIntoView({
                        block: "end",
                        behavior: Q.config.scrollBehavior
                    }))
            ...
            function Rr(ze, Gr, Wr, Kr) {
                ...
                if (Yr) {
                    ...
                    Qr.indexOf("{") !== 0 && (Qr = "{" + Qr + "}");
                    var Zr;
                    Jr ? Zr = Tr(ze, function() {
                        return Function("return (" + Qr + ")")()
                    }, {}) : Zr = E(Qr);
                    for (var ei in Zr)
                        Zr.hasOwnProperty(ei) && Kr[ei] == null && (Kr[ei] = Zr[ei])
                }
                return Rr(u(ze), Gr, Wr, Kr)
            }
            function Tr(ze, Gr, Wr) {
                return Q.config.allowEval ? Gr() : (fe(ze, "htmx:evalDisallowedError"),
                Wr)
            }
            function Or(ze, Gr) {
            ...
            function Lr(ze, Gr, Wr) {
                if (Wr !== null)
                    try {
                        ...
                        ze.setRequestHeader(Gr, encodeURIComponent(Wr)),
                        ze.setRequestHeader(Gr + "-URI-AutoEncoded", "true")
                    }
            }
            function Ar(ze) {
            ...
            function Nr(ze, Gr, Wr) {
                ...
                Wr ? Wr instanceof Element || I(Wr, "String") ? he(ze, Gr, null, null, {
                    targetOverride: p(Wr),
                    returnPromise: !0
                }) : he(ze, Gr, p(Wr.source), Wr.event, {
                    handler: Wr.handler,
                    headers: Wr.headers,
                    values: Wr.values,
                    targetOverride: p(Wr.target),
                    swapOverride: Wr.swap,
                    select: Wr.select,
                    returnPromise: !0
                }) : he(ze, Gr, null, null, {
                    returnPromise: !0
            ...
            function kr(ze, Gr, Wr) {
                ...
                if (typeof URL == "function") {
                    ...
                    Yr = Gr,
                    Kr = g(Gr, document.location.origin);
                return Q.config.selfRequestsOnly && !Kr ? !1 : ce(ze, "htmx:validateUrl", le({
                    url: Yr,
                    sameHost: Kr
                }, Wr))
            }
            function he(ze, Gr, Wr, Kr, Yr, Qr) {
                var Jr = null
                  , Zr = null;
                if (Yr = Yr ?? {},
                Yr.returnPromise && typeof Promise < "u")
                ...
                if (ii == null || ii == pe)
                    return fe(Wr, "htmx:targetError", {
                        target: te(Wr, "hx-target")
                    }),
                    ie(Zr),
                    ei;
                var ni = ae(Wr)
                ...
                if (hi) {
                    var bi = hi.split(":")
                      , yi = bi[0].trim();
                    if (yi === "this" ? ci = xe(Wr, "hx-sync") : ci = ue(Wr, yi),
                    hi = (bi[1] || "drop").trim(),
                    ni = ae(ci),
                    hi === "drop" && ni.xhr && ni.abortable !== !0)
                        return ie(Jr),
                        ei;
                    if (hi === "abort") {
                        if (ni.xhr)
                ...
                if (ni.xhr)
                    if (ni.abortable)
                        ...
                        fi === "first" && ni.queuedRequests.length === 0 ? ni.queuedRequests.push(function() {
                            he(ze, Gr, Wr, Kr, Yr)
                        }) : fi === "all" ? ni.queuedRequests.push(function() {
                            he(ze, Gr, Wr, Kr, Yr)
                        }) : fi === "last" && (ni.queuedRequests = [],
                ...
                if (oi && !Qr && !confirm(oi))
                    ...
                    ei;
                var xi = xr(Wr, ii, Ti);
                ze !== "get" && !Sr(Wr) && (xi["Content-Type"] = "application/x-www-form-urlencoded"),
                Yr.headers && (xi = le(xi, Yr.headers));
                var Mi = dr(Wr, ze)
                  , _i = Mi.errors
                  , Si = Mi.values;
                ...
                var Ai = Hr(Wr)
                  , Ci = le(Si, Ai)
                  , Oi = yr(Ci, Wr);
                Q.config.getCacheBusterParam && ze === "get" && (Oi["org.htmx.cache-buster"] = ee(ii, "id") || "true"),
                (Gr == null || Gr === "") && (Gr = re().location.href);
                ...
                if (!ce(Wr, "htmx:configRequest", Ii))
                    return ie(Jr),
                    wi(),
                    ei;
                if (Gr = Ii.path,
                ...
                zi = Ii.useUrlParams,
                _i && _i.length > 0)
                    return ce(Wr, "htmx:validation:halted", Ii),
                    ie(Jr),
                    wi(),
                    ei;
                var Vi = Gr.split("#")
                ...
                if (zi) {
                    ...
                    Wi && (ki.indexOf("?") < 0 ? ki += "?" : ki += "&",
                    ki += pr(Oi),
                    $i && (ki += "#" + $i))
                }
                if (!kr(Wr, ki, Ii))
                    return fe(Wr, "htmx:invalidPath", Ii),
                    ie(Zr),
                    ei;
                if (mi.open(ze.toUpperCase(), ki, !0),
                mi.overrideMimeType("text/html"),
                mi.withCredentials = Ii.withCredentials,
                mi.timeout = Ii.timeout,
                !Li.noHeaders) {
                    for (var Bi in xi)
                ...
                if (mi.onload = function() {
                    try {
                        var Ri = Ir(Wr);
                        if (Pi.pathInfo.responsePath = Ar(mi),
                        ti(Wr, Pi),
                        lr(Hi, Fi),
                        ce(Wr, "htmx:afterRequest", Pi),
                        ce(Wr, "htmx:afterOnLoad", Pi),
                        !se(Wr)) {
                            for (var Di = null; Ri.length > 0 && Di == null; ) {
                                var Ni = Ri.shift();
                                se(Ni) && (Di = Ni)
                            }
                            Di && (ce(Di, "htmx:afterRequest", Pi),
                            ce(Di, "htmx:afterOnLoad", Pi))
                        }
                        ie(Jr),
                        wi()
                    } catch (ji) {
                        throw fe(Wr, "htmx:onLoadError", le({
                            error: ji
                        }, Pi)),
                        ji
                    }
                ...
                mi.onerror = function() {
                    lr(Hi, Fi),
                    fe(Wr, "htmx:afterRequest", Pi),
                    fe(Wr, "htmx:sendError", Pi),
                    ie(Zr),
                    wi()
                }
                ,
                ...
                oe(["loadstart", "loadend", "progress", "abort"], function(Ri) {
                    oe([mi, mi.upload], function(Di) {
                        Di.addEventListener(Ri, function(Ni) {
                            ce(Wr, "htmx:xhr:" + Ri, {
                                lengthComputable: Ni.lengthComputable,
                                loaded: Ni.loaded,
                                total: Ni.total
                            })
                        })
            ...
            function Pr(ze, Gr) {
                var Wr = Gr.xhr
                  , Kr = null
                  , Yr = null;
                if (O(Wr, /HX-Push:/i) ? (Kr = Wr.getResponseHeader("HX-Push"),
                Yr = "push") : O(Wr, /HX-Push-Url:/i) ? (Kr = Wr.getResponseHeader("HX-Push-Url"),
                Yr = "push") : O(Wr, /HX-Replace-Url:/i) && (Kr = Wr.getResponseHeader("HX-Replace-Url"),
                Yr = "replace"),
                Kr)
                    return Kr === "false" ? {} : {
                        type: Yr,
                ...
                Gr.pathInfo.anchor && ii.indexOf("#") === -1 && (ii = ii + "#" + Gr.pathInfo.anchor),
                {
                    type: ri,
                    path: ii
                }) : {}
            ...
            function Mr(ze, Gr) {
                ...
                if (ce(ze, "htmx:beforeOnLoad", Gr)) {
                    if (O(Wr, /HX-Trigger:/i) && _e(Wr, "HX-Trigger", ze),
                    O(Wr, /HX-Location:/i)) {
                        er();
                        var Jr = Wr.getResponseHeader("HX-Location"), Zr;
                    ...
                    if (O(Wr, /HX-Redirect:/i)) {
                        location.href = Wr.getResponseHeader("HX-Redirect"),
                        ei && location.reload();
                        return
                    }
                    if (ei) {
                    ...
                    if (ce(Kr, "htmx:beforeSwap", li)) {
                        ...
                        li.shouldSwap) {
                            ...
                            Kr.classList.add(Q.config.swappingClass);
                            var oi = null
                              , ai = null
                              , pi = function() {
                                try {
                                    ...
                                    try {
                                        yi = {
                                            elt: bi,
                                            start: bi ? bi.selectionStart : null,
                                            end: bi ? bi.selectionEnd : null
                                        }
                                    } catch {}
                                    var Ei;
                                    Qr && (Ei = Qr),
                                    ...
                                    var di = T(Kr);
                                    if (je(Zr.swapStyle, Kr, ze, ii, di, Ei),
                                    ...
                                    if (Kr.classList.remove(Q.config.swappingClass),
                                    oe(di.elts, function(xi) {
                                        xi.classList && xi.classList.add(Q.config.settlingClass),
                                        ce(xi, "htmx:afterSwap", Gr)
                                    }),
                                    O(Wr, /HX-Trigger-After-Swap:/i)) {
                                        var gi = ze;
                                        se(ze) || (gi = re().body),
                                        _e(Wr, "HX-Trigger-After-Swap", gi)
                                    }
                                    var Ti = function() {
                                        if (oe(di.tasks, function(Si) {
                                            Si.call()
                                        }),
                                        oe(di.elts, function(Si) {
                                            Si.classList && Si.classList.remove(Q.config.settlingClass),
                                            ce(Si, "htmx:afterSettle", Gr)
                                        }),
                                        Gr.pathInfo.anchor) {
                                            var xi = re().getElementById(Gr.pathInfo.anchor);
                                            xi && xi.scrollIntoView({
                                                block: "start",
                                                behavior: "auto"
                                            })
                                        }
                                        ...
                                        if (Cr(di.elts, Zr),
                                        O(Wr, /HX-Trigger-After-Settle:/i)) {
                                            var _i = ze;
                                            se(ze) || (_i = re().body),
                                            _e(Wr, "HX-Trigger-After-Settle", _i)
                                        }
                                        ie(oi)
                                    };
                                    Zr.settleDelay > 0 ? setTimeout(Ti, Zr.settleDelay) : Ti()
                                } catch (xi) {
                                    throw fe(ze, "htmx:swapError", Gr),
                                    ie(ai),
                                    xi
                                }
                            }
                              , ci = Q.config.globalViewTransitions;
                            if (Zr.hasOwnProperty("transition") && (ci = Zr.transition),
                            ci && ce(ze, "htmx:beforeTransition", Gr) && typeof Promise < "u" && document.startViewTransition) {
                        ...
                        ni && fe(ze, "htmx:responseError", le({
                            error: "Response Status Error Code " + Wr.status + " from " + Gr.pathInfo.requestPath
                        }, Gr))
                    }
                }
            }
            ...
            function Fr(ze, Gr, Wr) {
                ...
                Wr == null && (Wr = []);
                var Kr = te(ze, "hx-ext");
                return Kr && oe(Kr.split(","), function(Yr) {
                    if (Yr = Yr.replace(/ /g, ""),
                    Yr.slice(0, 7) == "ignore:") {
                        Wr.push(Yr.slice(7));
                        return
...
function elementBoundEffect(ze) {
    ...
    return [Kr => {
        ...
        Gr = () => {
            Yr !== void 0 && (ze._x_effects.delete(Yr),
            release(Yr))
        }
        ,
        Yr
...
function watch(ze, Gr) {
    let Wr = !0, Kr, Yr = effect( () => {
        let Qr = ze();
        JSON.stringify(Qr),
        Wr ? Kr = Qr : queueMicrotask( () => {
            Gr(Qr, Kr),
            Kr = Qr
        }
        ),
...
function onElRemoved(ze, Gr) {
    typeof Gr == "function" ? (ze._x_cleanups || (ze._x_cleanups = []),
    ze._x_cleanups.push(Gr)) : (Gr = ze,
    onElRemoveds.push(Gr))
}
...
function onAttributeRemoved(ze, Gr, Wr) {
    ...
    ze._x_attributeCleanups[Gr] || (ze._x_attributeCleanups[Gr] = []),
    ze._x_attributeCleanups[Gr].push(Wr)
}
function cleanupAttributes(ze, Gr) {
    ze._x_attributeCleanups && Object.entries(ze._x_attributeCleanups).forEach( ([Wr,Kr]) => {
        (Gr === void 0 || Gr.includes(Wr)) && (Kr.forEach(Yr => Yr()),
        delete ze._x_attributeCleanups[Wr])
    }
    )
}
...
function onMutate(ze) {
    ...
    for (let Qr = 0; Qr < ze.length; Qr++)
        if (!ze[Qr].target._x_ignoreMutationObserver && (ze[Qr].type === "childList" && (ze[Qr].addedNodes.forEach(Jr => Jr.nodeType === 1 && Gr.add(Jr)),
        ze[Qr].removedNodes.forEach(Jr => Jr.nodeType === 1 && Wr.add(Jr))),
        ze[Qr].type === "attributes")) {
            let Jr = ze[Qr].target
    ...
    for (let Qr of Wr)
        Gr.has(Qr) || onElRemoveds.forEach(Jr => Jr(Qr));
    Gr.forEach(Qr => {
        Qr._x_ignoreSelf = !0,
        Qr._x_ignore = !0
    }
    ...
    for (let Qr of Gr)
        Wr.has(Qr) || Qr.isConnected && (delete Qr._x_ignoreSelf,
        delete Qr._x_ignore,
        onElAddeds.forEach(Jr => Jr(Qr)),
        Qr._x_ignore = !0,
        Qr._x_ignoreSelf = !0);
    Gr.forEach(Qr => {
        delete Qr._x_ignoreSelf,
        delete Qr._x_ignore
    }
    ),
    Gr = null,
...
function addScopeToNode(ze, Gr, Wr) {
    return ze._x_dataStack = [Gr, ...closestDataStack(Wr || ze)],
    () => {
...
function collapseProxies() {
    return Reflect.ownKeys(this).reduce( (Gr, Wr) => (Gr[Wr] = Reflect.get(this, Wr),
    Gr), {})
}
...
function interceptor(ze, Gr= () => {}
    ...
    let Wr = {
        ...
        _x_interceptor: !0,
        initialize(Kr, Yr, Qr) {
            return ze(this.initialValue, () => get(Kr, Yr), Jr => set(Kr, Yr, Jr), Yr, Qr)
        }
    };
    return Gr(Wr),
    Kr => {
...
function set(ze, Gr, Wr) {
    if (typeof Gr == "string" && (Gr = Gr.split(".")),
    Gr.length === 1)
        ze[Gr[0]] = Wr;
    else {
        if (Gr.length === 0)
            throw error;
        return ze[Gr[0]] || (ze[Gr[0]] = {}),
        set(ze[Gr[0]], Gr.slice(1), Wr)
    }
}
var magics = {};
...
function injectMagics(ze, Gr) {
    return Object.entries(magics).forEach( ([Wr,Kr]) => {
        let Yr = null;
        function Qr() {
            if (Yr)
                return Yr;
...
function dontAutoEvaluateFunctions(ze) {
    ...
    let Wr = ze();
    return shouldAutoEvaluateFunctions = Gr,
    Wr
}
function evaluate(ze, Gr, Wr={}) {
    let Kr;
    return evaluateLater(ze, Gr)(Yr => Kr = Yr, Wr),
    Kr
}
    ...
    let Wr = Object.getPrototypeOf(async function() {}).constructor
      ...
      , Qr = ( () => {
        try {
            ...
            return handleError(Jr, Gr, ze),
            Promise.resolve()
        }
    }
    )();
    return evaluatorMemo[ze] = Qr,
    Qr
}
function generateEvaluatorFromString(ze, Gr, Wr) {
    ...
    , {scope: Qr={}, params: Jr=[]}={}) => {
        ...
        if (typeof Kr == "function") {
            ...
            Kr.finished ? (runIfTypeOfFunction(Yr, Kr.result, Zr, Jr, Wr),
            Kr.result = void 0) : ei.then(ti => {
                runIfTypeOfFunction(Yr, ti, Zr, Jr, Wr)
            }
            ).catch(ti => handleError(ti, Wr, Gr)).finally( () => Kr.result = void 0)
        }
    }
}
function runIfTypeOfFunction(ze, Gr, Wr, Kr, Yr) {
    if (shouldAutoEvaluateFunctions && typeof Gr == "function") {
        ...
        typeof Gr == "object" && Gr instanceof Promise ? Gr.then(Qr => ze(Qr)) : ze(Gr)
}
...
function directive(ze, Gr) {
    return directiveHandlers[ze] = Gr,
    {
        before(Wr) {
...
function directives(ze, Gr, Wr) {
    ...
    ze._x_virtualDirectives) {
        let Qr = Object.entries(ze._x_virtualDirectives).map( ([Zr,ei]) => ({
            name: Zr,
            value: ei
        }))
    ...
    let Kr = {};
    return Gr.map(toTransformedAttributes( (Qr, Jr) => Kr[Qr] = Jr)).filter(outNonAlpineAttributes).map(toParsedDirectives(Kr, Wr)).sort(byPriority).map(Qr => getDirectiveHandler(ze, Qr))
}
function attributesOnly(ze) {
    return Array.from(ze).map(toTransformedAttributes()).filter(Gr => !outNonAlpineAttributes(Gr))
}
...
function deferHandlingDirectives(ze) {
    ...
    let Gr = Symbol();
    currentHandlerStackKey = Gr,
    directiveHandlerStacks.set(Gr, []);
    let Wr = () => {
        for (; directiveHandlerStacks.get(Gr).length; )
            directiveHandlerStacks.get(Gr).shift()();
...
function getDirectiveHandler(ze, Gr) {
    ...
    let Jr = () => {
        ze._x_ignore || ze._x_ignoreSelf || (Kr.inline && Kr.inline(ze, Gr, Yr),
        Kr = Kr.bind(Kr, ze, Gr, Yr),
        isDeferringHandlers ? directiveHandlerStacks.get(currentHandlerStackKey).push(Kr) : Kr())
    }
    ;
    return Jr.runCleanups = Qr,
    Jr
}
var startingWith = (ze, Gr) => ({name: Wr, value: Kr}) => (Wr.startsWith(ze) && (Wr = Wr.replace(ze, Gr)),
{
    name: Wr,
    value: Kr
})
...
function toTransformedAttributes(ze= () => {}
    ...
    return ({name: Gr, value: Wr}) => {
        let {name: Kr, value: Yr} = attributeTransformers.reduce( (Qr, Jr) => Jr(Qr), {
            name: Gr,
            value: Wr
        });
        return Kr !== Gr && ze(Kr, Gr),
        {
            name: Kr,
            value: Yr
        }
...
function dispatch(ze, Gr, Wr={}) {
    ze.dispatchEvent(new CustomEvent(Gr,{
        detail: Wr,
        bubbles: !0,
        composed: !0,
        cancelable: !0
...
function start() {
    ...
    Array.from(document.querySelectorAll(allSelectors().join(","))).filter(ze).forEach(Gr => {
        initTree(Gr)
    }
    ),
...
function closestRoot(ze, Gr=!1) {
    return findClosest(ze, Wr => {
        if ((Gr ? allSelectors() : rootSelectors()).some(Yr => Wr.matches(Yr)))
            return !0
    }
    )
}
function findClosest(ze, Gr) {
    if (ze) {
        ...
        !!ze.parentElement)
            return findClosest(ze.parentElement, Gr)
    }
}
function isRoot(ze) {
...
function initTree(ze, Gr=walk, Wr= () => {}
    ...
    deferHandlingDirectives( () => {
        Gr(ze, (Kr, Yr) => {
            Wr(Kr, Yr),
            initInterceptors2.forEach(Qr => Qr(Kr, Yr)),
            directives(Kr, Kr.attributes).forEach(Qr => Qr()),
            Kr._x_ignore && Yr()
        }
        )
    }
...
function destroyTree(ze, Gr=walk) {
    Gr(ze, Wr => {
        cleanupAttributes(Wr),
        cleanupElement(Wr)
    }
    )
}
function warnAboutMissingPlugins() {
    [["ui", "dialog", ["[x-dialog], [x-popover]"]], ["anchor", "anchor", ["[x-anchor]"]], ["sort", "sort", ["[x-sort]"]]].forEach( ([Gr,Wr,Kr]) => {
        directiveExists(Wr) || Kr.some(Yr => {
            if (document.querySelector(Yr))
                return warn(`found "${Yr}", but missing ${Gr} plugin`),
                !0
        }
        )
    }
...
function setClassesFromString(ze, Gr) {
    let Wr = Yr => Yr.split(" ").filter(Qr => !ze.classList.contains(Qr)).filter(Boolean)
      , Kr = Yr => (ze.classList.add(...Yr),
    () => {
        ze.classList.remove(...Yr)
    }
    );
    return Gr = Gr === !0 ? Gr = "" : Gr || "",
    Kr(Wr(Gr))
}
function setClassesFromObject(ze, Gr) {
    let Wr = Zr => Zr.split(" ").filter(Boolean)
      , Kr = Object.entries(Gr).flatMap( ([Zr,ei]) => ei ? Wr(Zr) : !1).filter(Boolean)
      , Yr = Object.entries(Gr).flatMap( ([Zr,ei]) => ei ? !1 : Wr(Zr)).filter(Boolean)
      , Qr = []
      , Jr = [];
    return Yr.forEach(Zr => {
    ...
    () => {
        Jr.forEach(Zr => ze.classList.add(Zr)),
        Qr.forEach(Zr => ze.classList.remove(Zr))
    }
}
...
function setStylesFromObject(ze, Gr) {
    let Wr = {};
    return Object.entries(Gr).forEach( ([Kr,Yr]) => {
        Wr[Kr] = ze.style[Kr],
        Kr.startsWith("--") || (Kr = kebabCase(Kr)),
        ze.style.setProperty(Kr, Yr)
    }
    ),
    setTimeout( () => {
...
function setStylesFromString(ze, Gr) {
    ...
    return ze.setAttribute("style", Gr),
    () => {
...
function once(ze, Gr= () => {}
    ...
    let Wr = !1;
    return function() {
        Wr ? Gr.apply(this, arguments) : (Wr = !0,
        ze.apply(this, arguments))
    }
}
directive("transition", (ze, {value: Gr, modifiers: Wr, expression: Kr}, {evaluate: Yr}) => {
    typeof Kr == "function" && (Kr = Yr(Kr)),
    Kr !== !1 && (!Kr || typeof Kr == "boolean" ? registerTransitionsFromHelper(ze, Wr, Gr) : registerTransitionsFromClassString(ze, Kr, Gr))
}
);
...
function registerTransitionsFromHelper(ze, Gr, Wr) {
    ...
    Gr.includes("in") && !Kr && (Gr = Gr.filter( (ai, pi) => pi < Gr.indexOf("out"))),
    Gr.includes("out") && !Kr && (Gr = Gr.filter( (ai, pi) => pi > Gr.indexOf("out")));
    ...
    Yr && (ze._x_transition.enter.during = {
        transformOrigin: ni,
        transitionDelay: `${ii}s`,
        transitionProperty: si,
        transitionDuration: `${li}s`,
        transitionTimingFunction: oi
    },
    ...
    Qr && (ze._x_transition.leave.during = {
        transformOrigin: ni,
        transitionDelay: `${ii}s`,
        transitionProperty: si,
        transitionDuration: `${ui}s`,
        transitionTimingFunction: oi
    },
...
function closestHide(ze) {
    ...
    if (Gr)
        return Gr._x_hidePromise ? Gr : closestHide(Gr)
}
function transition$1(ze, Gr, {during: Wr, start: Kr, end: Yr}={}, Qr= () => {}
, Jr= () => {}
) {
    if (ze._x_transitioning && ze._x_transitioning.cancel(),
    Object.keys(Wr).length === 0 && Object.keys(Kr).length === 0 && Object.keys(Yr).length === 0) {
        Qr(),
        Jr();
        return
    }
...
function bind(ze, Gr, Wr, Kr=[]) {
    ...
    ze._x_bindings[Gr] = Wr,
    Gr = Kr.includes("camel") ? camelCase(Gr) : Gr,
    Gr) {
    case "value":
...
function bindInputValue(ze, Gr) {
    if (ze.type === "radio")
        ze.attributes.value === void 0 && (ze.value = Gr),
        window.fromModel && (typeof Gr == "boolean" ? ze.checked = safeParseBoolean(ze.value) === Gr : ze.checked = checkedAttrLooseCompare(ze.value, Gr));
    else if (ze.type === "checkbox")
        Number.isInteger(Gr) ? ze.value = Gr : !Array.isArray(Gr) && typeof Gr != "boolean" && ![null, void 0].includes(Gr) ? ze.value = String(Gr) : Array.isArray(Gr) ? ze.checked = Gr.some(Wr => checkedAttrLooseCompare(Wr, ze.value)) : ze.checked = !!Gr;
...
function bindClasses(ze, Gr) {
    ...
    ze._x_undoAddedClasses = setClasses(ze, Gr)
}
function bindStyles(ze, Gr) {
    ze._x_undoAddedStyles && ze._x_undoAddedStyles(),
    ze._x_undoAddedStyles = setStyles(ze, Gr)
}
function bindAttributeAndProperty(ze, Gr, Wr) {
    bindAttribute(ze, Gr, Wr),
    setPropertyIfChanged(ze, Gr, Wr)
}
function bindAttribute(ze, Gr, Wr) {
    [null, void 0, !1].includes(Wr) && attributeShouldntBePreservedIfFalsy(Gr) ? ze.removeAttribute(Gr) : (isBooleanAttr(Gr) && (Wr = Gr),
    setIfChanged(ze, Gr, Wr))
}
...
function isBooleanAttr(ze) {
    return ["disabled", "checked", "required", "readonly", "open", "selected", "autofocus", "itemscope", "multiple", "novalidate", "allowfullscreen", "allowpaymentrequest", "formnovalidate", "autoplay", "controls", "loop", "muted", "playsinline", "default", "ismap", "reversed", "async", "defer", "nomodule"].includes(ze)
}
...
function extractProp(ze, Gr, Wr, Kr=!0) {
    if (ze._x_bindings && ze._x_bindings[Gr] !== void 0)
        return ze._x_bindings[Gr];
    if (ze._x_inlineBindings && ze._x_inlineBindings[Gr] !== void 0) {
        let Yr = ze._x_inlineBindings[Gr];
        return Yr.extract = Kr,
        dontAutoEvaluateFunctions( () => evaluate(ze, Yr.expression))
    }
...
function store(ze, Gr) {
    ...
    Gr === void 0)
        return stores[ze];
    stores[ze] = Gr,
    typeof Gr == "object" && Gr !== null && Gr.hasOwnProperty("init") && typeof Gr.init == "function" && stores[ze].init(),
    initInterceptors(stores[ze])
}
function getStores() {
    return stores
}
...
function injectBindingProviders(ze) {
    return Object.entries(binds).forEach( ([Gr,Wr]) => {
...
function applyBindingsObject(ze, Gr, Wr) {
    ...
    for (; Kr.length; )
        Kr.pop()();
    let Yr = Object.entries(Gr).map( ([Jr,Zr]) => ({
        name: Jr,
        value: Zr
    }))
      , Qr = attributesOnly(Yr);
    return Yr = Yr.map(Jr => Qr.find(Zr => Zr.name === Jr.name) ? {
        name: `x-bind:${Jr.name}`,
        value: `"${Jr.value}"`
    } : Jr),
    directives(ze, Yr, Wr).map(Jr => {
        Kr.push(Jr.runCleanups),
        Jr()
    }
    ),
    () => {
...
function injectDataProviders(ze, Gr) {
    return Object.entries(datas).forEach( ([Wr,Kr]) => {
        Object.defineProperty(ze, Wr, {
            get() {
...
function makeMap(ze, Gr) {
    const Wr = Object.create(null)
      , Kr = ze.split(",");
    for (let Yr = 0; Yr < Kr.length; Yr++)
        Wr[Kr[Yr]] = !0;
    return Yr => !!Wr[Yr]
}
var EMPTY_OBJ = Object.freeze({}), hasOwnProperty = Object.prototype.hasOwnProperty, hasOwn = (ze, Gr) => hasOwnProperty.call(ze, Gr), isArray = Array.isArray, isMap = ze => toTypeString(ze) === "[object Map]", isString = ze => typeof ze == "string", isSymbol = ze => typeof ze == "symbol", isObject$2 = ze => ze !== null && typeof ze == "object", objectToString = Object.prototype.toString, toTypeString = ze => objectToString.call(ze), toRawType = ze => toTypeString(ze).slice(8, -1), isIntegerKey = ze => isString(ze) && ze !== "NaN" && ze[0] !== "-" && "" + parseInt(ze, 10) === ze, cacheStringFunction = ze => {
    const Gr = Object.create(null);
    return Wr => Gr[Wr] || (Gr[Wr] = ze(Wr))
}
, capitalize = cacheStringFunction(ze => ze.charAt(0).toUpperCase() + ze.slice(1)), hasChanged = (ze, Gr) => ze !== Gr && (ze === ze || Gr === Gr), targetMap = new WeakMap, effectStack = [], activeEffect, ITERATE_KEY = Symbol("iterate"), MAP_KEY_ITERATE_KEY = Symbol("Map key iterate");
...
function createReactiveEffect(ze, Gr) {
    ...
    return Wr.id = uid++,
    Wr.allowRecurse = !!Gr.allowRecurse,
    Wr._isEffect = !0,
    Wr.active = !0,
    Wr.raw = ze,
    Wr.deps = [],
...
function track(ze, Gr, Wr) {
    ...
    let Yr = Kr.get(Wr);
    Yr || Kr.set(Wr, Yr = new Set),
    Yr.has(activeEffect) || (Yr.add(activeEffect),
    activeEffect.deps.push(Yr),
...
function trigger(ze, Gr, Wr, Kr, Yr, Qr) {
    ...
    if (Gr === "clear")
        ...
        switch (Wr !== void 0 && ei(Jr.get(Wr)),
        Gr) {
        case "add":
            isArray(ze) ? isIntegerKey(Wr) && ei(Jr.get("length")) : (ei(Jr.get(ITERATE_KEY)),
            isMap(ze) && ei(Jr.get(MAP_KEY_ITERATE_KEY)));
            break;
        case "delete":
            isArray(ze) || (ei(Jr.get(ITERATE_KEY)),
            isMap(ze) && ei(Jr.get(MAP_KEY_ITERATE_KEY)));
            break;
        case "set":
...
function createArrayInstrumentations() {
    const ze = {};
    return ["includes", "indexOf", "lastIndexOf"].forEach(Gr => {
        ze[Gr] = function(...Wr) {
            const Kr = toRaw(this);
...
function createGetter(ze=!1, Gr=!1) {
    return function(Kr, Yr, Qr) {
        if (Yr === "__v_isReactive")
            return !ze;
        if (Yr === "__v_isReadonly")
            return ze;
        if (Yr === "__v_raw" && Qr === (ze ? Gr ? shallowReadonlyMap : readonlyMap : Gr ? shallowReactiveMap : reactiveMap).get(Kr))
            return Kr;
        const Jr = isArray(Kr);
        if (!ze && Jr && hasOwn(arrayInstrumentations, Yr))
            return Reflect.get(arrayInstrumentations, Yr, Qr);
        const Zr = Reflect.get(Kr, Yr, Qr);
        return (isSymbol(Yr) ? builtInSymbols.has(Yr) : isNonTrackableKeys(Yr)) || (ze || track(Kr, "get", Yr),
        Gr) ? Zr : isRef(Zr) ? !Jr || !isIntegerKey(Yr) ? Zr.value : Zr : isObject$2(Zr) ? ze ? readonly(Zr) : reactive2(Zr) : Zr
    }
}
...
function createSetter(ze=!1) {
    return function(Wr, Kr, Yr, Qr) {
        ...
        if (!ze && (Yr = toRaw(Yr),
        Jr = toRaw(Jr),
        !isArray(Wr) && isRef(Jr) && !isRef(Yr)))
            return Jr.value = Yr,
            !0;
        const Zr = isArray(Wr) && isIntegerKey(Kr) ? Number(Kr) < Wr.length : hasOwn(Wr, Kr)
          , ei = Reflect.set(Wr, Kr, Yr, Qr);
        return Wr === toRaw(Qr) && (Zr ? hasChanged(Yr, Jr) && trigger(Wr, "set", Kr, Yr, Jr) : trigger(Wr, "add", Kr, Yr)),
        ei
    }
}
function deleteProperty(ze, Gr) {
    ...
    return Yr && Wr && trigger(ze, "delete", Gr, void 0, Kr),
    Yr
}
function has(ze, Gr) {
    const Wr = Reflect.has(ze, Gr);
    return (!isSymbol(Gr) || !builtInSymbols.has(Gr)) && track(ze, "has", Gr),
    Wr
}
function ownKeys(ze) {
...
var mutableHandlers = {
  ...
  , readonlyHandlers = {
    get: readonlyGet,
    set(ze, Gr) {
        return console.warn(`Set operation on key "${String(Gr)}" failed: target is readonly.`, ze),
        !0
    },
    deleteProperty(ze, Gr) {
        return console.warn(`Delete operation on key "${String(Gr)}" failed: target is readonly.`, ze),
        !0
    }
}
...
function has$1(ze, Gr=!1) {
    const Wr = this.__v_raw
      , Kr = toRaw(Wr)
      , Yr = toRaw(ze);
    return ze !== Yr && !Gr && track(Kr, "has", ze),
    !Gr && track(Kr, "has", Yr),
    ze === Yr ? Wr.has(ze) : Wr.has(ze) || Wr.has(Yr)
}
function size(ze, Gr=!1) {
    return ze = ze.__v_raw,
    !Gr && track(toRaw(ze), "iterate", ITERATE_KEY),
    Reflect.get(ze, "size", ze)
}
function add(ze) {
    ze = toRaw(ze);
    const Gr = toRaw(this);
    return getProto(Gr).has.call(Gr, ze) || (Gr.add(ze),
    trigger(Gr, "add", ze, ze)),
    this
}
function set$1(ze, Gr) {
    ...
    Qr ? checkIdentityKeys(Wr, Kr, ze) : (ze = toRaw(ze),
    Qr = Kr.call(Wr, ze));
    const Jr = Yr.call(Wr, ze);
    return Wr.set(ze, Gr),
    Qr ? hasChanged(Gr, Jr) && trigger(Wr, "set", ze, Gr, Jr) : trigger(Wr, "add", ze, Gr),
    this
}
function deleteEntry(ze) {
    ...
    Yr ? checkIdentityKeys(Gr, Wr, ze) : (ze = toRaw(ze),
    Yr = Wr.call(Gr, ze));
    const Qr = Kr ? Kr.call(Gr, ze) : void 0
      , Jr = Gr.delete(ze);
    return Yr && trigger(Gr, "delete", ze, void 0, Qr),
    Jr
}
function clear() {
    const ze = toRaw(this)
      ...
      , Kr = ze.clear();
    return Gr && trigger(ze, "clear", void 0, void 0, Wr),
    Kr
}
function createForEach(ze, Gr) {
    return function(Kr, Yr) {
        ...
        Jr.forEach( (ti, ri) => Kr.call(Yr, ei(ti), ei(ri), Qr))
    }
}
function createIterableMethod(ze, Gr, Wr) {
    return function(...Kr) {
        ...
        return !Gr && track(Qr, "iterate", ei ? MAP_KEY_ITERATE_KEY : ITERATE_KEY),
        {
            next() {
...
function createInstrumentations() {
    ...
    return ["keys", "values", "entries", Symbol.iterator].forEach(Qr => {
        ze[Qr] = createIterableMethod(Qr, !1, !1),
        Wr[Qr] = createIterableMethod(Qr, !0, !1),
        Gr[Qr] = createIterableMethod(Qr, !1, !0),
        Kr[Qr] = createIterableMethod(Qr, !0, !0)
    }
    ),
    [ze, Wr, Gr, Kr]
}
...
function checkIdentityKeys(ze, Gr, Wr) {
    ...
    if (Kr !== Wr && Gr.call(ze, Kr)) {
        ...
        console.warn(`Reactive ${Yr} contains both the raw and reactive versions of the same object${Yr === "Map" ? " as keys" : ""}, which can lead to inconsistencies. Avoid differentiating between the raw and reactive versions of an object and only use the reactive version if possible.`)
    }
}
...
function createReactiveObject(ze, Gr, Wr, Kr, Yr) {
    if (!isObject$2(ze))
        ...
        ze;
    if (ze.__v_raw && !(Gr && ze.__v_isReactive))
        return ze;
    const Qr = Yr.get(ze);
    if (Qr)
        return Qr;
...
function setIdRoot(ze, Gr) {
    ze._x_ids || (ze._x_ids = {}),
    ze._x_ids[Gr] || (ze._x_ids[Gr] = findAndIncrementId(Gr))
}
...
function cacheIdByNameOnElement(ze, Gr, Wr, Kr) {
    if (ze._x_id || (ze._x_id = {}),
    ze._x_id[Gr])
        return ze._x_id[Gr];
    let Yr = Kr();
    return ze._x_id[Gr] = Yr,
    Wr( () => {
        delete ze._x_id[Gr]
    }
    ),
...
directive("teleport", (ze, {modifiers: Gr, expression: Wr}, {cleanup: Kr}) => {
    ...
    ze._x_forwardEvents && ze._x_forwardEvents.forEach(Zr => {
        Qr.addEventListener(Zr, ei => {
            ei.stopPropagation(),
            ze.dispatchEvent(new ei.constructor(ei.type,ei))
        }
        )
    }
    ),
...
function getTarget(ze) {
    let Gr = skipDuringClone( () => document.querySelector(ze), () => teleportContainerDuringClone)();
    return Gr || warn(`Cannot find x-teleport element for selector: "${ze}"`),
    Gr
}
var handler = () => {}
;
...
directive("effect", skipDuringClone( (ze, {expression: Gr}, {effect: Wr}) => {
...
function on(ze, Gr, Wr, Kr) {
    ...
    if (Wr.includes("dot") && (Gr = dotSyntax(Gr)),
    ...
    return Wr.includes("prevent") && (Qr = Zr(Qr, (ei, ti) => {
        ti.preventDefault(),
        ei(ti)
    }
    )),
    Wr.includes("stop") && (Qr = Zr(Qr, (ei, ti) => {
        ti.stopPropagation(),
        ei(ti)
    }
    )),
    Wr.includes("once") && (Qr = Zr(Qr, (ei, ti) => {
        ei(ti),
        Yr.removeEventListener(Gr, Qr, Jr)
    }
    )),
    (Wr.includes("away") || Wr.includes("outside")) && (Yr = document,
    Qr = Zr(Qr, (ei, ti) => {
        ze.contains(ti.target) || ti.target.isConnected !== !1 && (ze.offsetWidth < 1 && ze.offsetHeight < 1 || ze._x_isShown !== !1 && ei(ti))
    }
    )),
    Wr.includes("self") && (Qr = Zr(Qr, (ei, ti) => {
        ti.target === ze && ei(ti)
    }
    )),
    (isKeyEvent(Gr) || isClickEvent(Gr)) && (Qr = Zr(Qr, (ei, ti) => {
...
function isListeningForASpecificKeyThatHasntBeenPressed(ze, Gr) {
    ...
    if (Wr.length === 0 || Wr.length === 1 && keyToModifiers(ze.key).includes(Wr[0]))
        return !1;
    const Yr = ["ctrl", "shift", "alt", "meta", "cmd", "super"].filter(Qr => Wr.includes(Qr));
    return Wr = Wr.filter(Qr => !Yr.includes(Qr)),
    !(Yr.length > 0 && Yr.filter(Jr => ((Jr === "cmd" || Jr === "super") && (Jr = "meta"),
    ze[`${Jr}Key`])).length === Yr.length && (isClickEvent(ze.type) || keyToModifiers(ze.key).includes(Wr[0])))
}
...
directive("model", (ze, {modifiers: Gr, expression: Wr}, {effect: Kr, cleanup: Yr}) => {
    ...
    ;
    typeof Wr == "string" && ze.type === "radio" && mutateDom( () => {
    ...
    if (Gr.includes("fill") && ([void 0, null, ""].includes(ei()) || ze.type === "checkbox" && Array.isArray(ei()) || ze.tagName.toLowerCase() === "select" && ze.multiple) && ti(getInputValue(ze, Gr, {
        target: ze
    }, ei())),
    ...
    ze.form) {
        let ni = on(ze.form, "reset", [], si => {
            nextTick$1( () => ze._x_model && ze._x_model.set(getInputValue(ze, Gr, {
                target: ze
            }, ei())))
        }
        );
    ...
    ze._x_forceModelUpdate = ni => {
        ni === void 0 && typeof Wr == "string" && Wr.match(/\./) && (ni = ""),
        window.fromModel = !0,
        mutateDom( () => bind(ze, "value", ni)),
...
function getInputValue(ze, Gr, Wr, Kr) {
    return mutateDom( () => {
        if (Wr instanceof CustomEvent && Wr.detail !== void 0)
            return Wr.detail !== null && Wr.detail !== void 0 ? Wr.detail : Wr.target.value;
        if (ze.type === "checkbox")
            if (Array.isArray(Kr)) {
                let Yr = null;
                return Gr.includes("number") ? Yr = safeParseNumber(Wr.target.value) : Gr.includes("boolean") ? Yr = safeParseBoolean(Wr.target.value) : Yr = Wr.target.value,
                Wr.target.checked ? Kr.includes(Yr) ? Kr : Kr.concat([Yr]) : Kr.filter(Qr => !checkedAttrLooseCompare2(Qr, Yr))
            } else
                return Wr.target.checked;
        else {
            if (ze.tagName.toLowerCase() === "select" && ze.multiple)
                return Gr.includes("number") ? Array.from(Wr.target.selectedOptions).map(Yr => {
                    let Qr = Yr.value || Yr.text;
                    return safeParseNumber(Qr)
                }
                ) : Gr.includes("boolean") ? Array.from(Wr.target.selectedOptions).map(Yr => {
                    let Qr = Yr.value || Yr.text;
            ...
            {
                let Yr;
                return ze.type === "radio" ? Wr.target.checked ? Yr = Wr.target.value : Yr = Kr : Yr = Wr.target.value,
...
directive("init", skipDuringClone( (ze, {expression: Gr}, {evaluate: Wr}) => typeof Gr == "string" ? !!Gr.trim() && Wr(Gr, {}, !1) : Wr(Gr, {}, !1)));
...
var handler2 = (ze, {value: Gr, modifiers: Wr, expression: Kr, original: Yr}, {effect: Qr, cleanup: Jr}) => {
    ...
    if (Gr === "key")
        return storeKeyForXFor(ze, Kr);
    if (ze._x_inlineBindings && ze._x_inlineBindings[Gr] && ze._x_inlineBindings[Gr].extract)
        return;
    let Zr = evaluateLater(ze, Kr);
    Qr( () => Zr(ei => {
        ei === void 0 && typeof Kr == "string" && Kr.match(/\./) && (ei = ""),
        mutateDom( () => bind(ze, Gr, ei, Wr))
    }
    )),
    Jr( () => {
        ze._x_undoAddedClasses && ze._x_undoAddedClasses(),
...
handler2.inline = (ze, {value: Gr, modifiers: Wr, expression: Kr}) => {
    Gr && (ze._x_inlineBindings || (ze._x_inlineBindings = {}),
    ze._x_inlineBindings[Gr] = {
        expression: Kr,
        extract: !1
    })
}
...
directive("data", (ze, {expression: Gr}, {cleanup: Wr}) => {
    ...
    Wr( () => {
        Jr.destroy && evaluate(ze, Jr.destroy),
        Zr()
    }
    )
}
...
interceptClone( (ze, Gr) => {
    ze._x_dataStack && (Gr._x_dataStack = ze._x_dataStack,
    Gr.setAttribute("data-has-alpine-state", !0))
}
);
...
directive("show", (ze, {modifiers: Gr, expression: Wr}, {effect: Kr}) => {
    ...
    Kr( () => Yr(ii => {
        !ri && ii === ti || (Gr.includes("immediate") && (ii ? Zr() : Qr()),
        ei(ii),
        ti = ii,
        ri = !1)
    }
...
function loop$1(ze, Gr, Wr, Kr) {
    let Yr = Jr => typeof Jr == "object" && !Array.isArray(Jr)
      , Qr = ze;
    Wr(Jr => {
        isNumeric3(Jr) && Jr >= 0 && (Jr = Array.from(Array(Jr).keys(), oi => oi + 1)),
        Jr === void 0 && (Jr = []);
        let Zr = ze._x_lookup
          , ei = ze._x_prevKeys
          , ti = []
        ...
        if (Yr(Jr))
            Jr = Object.entries(Jr).map( ([oi,ai]) => {
                ...
                Kr(ci => {
                    ri.includes(ci) && warn("Duplicate key on x-for", ze),
                    ri.push(ci)
                }
                , {
                    scope: {
            ...
            for (let oi = 0; oi < Jr.length; oi++) {
                ...
                Kr(pi => {
                    ri.includes(pi) && warn("Duplicate key on x-for", ze),
                    ri.push(pi)
                }
                , {
                    scope: {
        ...
        for (let oi = 0; oi < si.length; oi++) {
            let ai = si[oi];
            Zr[ai]._x_effects && Zr[ai]._x_effects.forEach(dequeueJob),
            Zr[ai].remove(),
            Zr[ai] = null,
            delete Zr[ai]
        }
        for (let oi = 0; oi < ni.length; oi++) {
            ...
            mutateDom( () => {
                hi || warn('x-for ":key" is undefined or invalid', Qr, pi, Zr),
                hi.after(fi),
                ci.after(hi),
                hi._x_currentIfEl && hi.after(hi._x_currentIfEl),
                fi.before(ci),
                ci._x_currentIfEl && ci.after(ci._x_currentIfEl),
                fi.remove()
            }
            ),
        ...
        for (let oi = 0; oi < li.length; oi++)
            Zr[li[oi]]._x_refreshXForScope(ti[ri.indexOf(li[oi])]);
        Qr._x_prevKeys = ri
    }
    )
}
function parseForExpression(ze) {
    ...
    let Jr = Yr[1].replace(Wr, "").trim()
      , Zr = Jr.match(Gr);
    return Zr ? (Qr.item = Jr.replace(Gr, "").trim(),
    Qr.index = Zr[1].trim(),
...
function getIterationScopeVariables(ze, Gr, Wr, Kr) {
    let Yr = {};
    return /^\[.*\]$/.test(ze.item) && Array.isArray(Gr) ? ze.item.replace("[", "").replace("]", "").split(",").map(Jr => Jr.trim()).forEach( (Jr, Zr) => {
        Yr[Jr] = Gr[Zr]
    }
    ) : /^\{.*\}$/.test(ze.item) && !Array.isArray(Gr) && typeof Gr == "object" ? ze.item.replace("{", "").replace("}", "").split(",").map(Jr => Jr.trim()).forEach(Jr => {
        Yr[Jr] = Gr[Jr]
    }
    ) : Yr[ze.item] = Gr,
...
handler3.inline = (ze, {expression: Gr}, {cleanup: Wr}) => {
    ...
    Kr._x_refs || (Kr._x_refs = {}),
    Kr._x_refs[Gr] = ze,
    Wr( () => delete Kr._x_refs[Gr])
}
;
...
directive("on", skipDuringClone( (ze, {value: Gr, modifiers: Wr, expression: Kr}, {cleanup: Yr}) => {
    let Qr = Kr ? evaluateLater(ze, Kr) : () => {}
    ;
    ze.tagName.toLowerCase() === "template" && (ze._x_forwardEvents || (ze._x_forwardEvents = []),
    ze._x_forwardEvents.includes(Gr) || ze._x_forwardEvents.push(Gr));
...
function getDocument() {
    ...
    return extend$1(ze, ssrDocument),
    ze
}
const ssrWindow = {
    ...
    requestAnimationFrame(ze) {
        return typeof setTimeout > "u" ? (ze(),
        null) : setTimeout(ze, 0)
    },
...
function getWindow() {
    ...
    return extend$1(ze, ssrWindow),
    ze
}
function classesToTokens(ze) {
    return ze === void 0 && (ze = ""),
    ze.trim().split(" ").filter(Gr => !!Gr.trim())
}
...
function getComputedStyle$1(ze) {
    const Gr = getWindow();
    let Wr;
    return Gr.getComputedStyle && (Wr = Gr.getComputedStyle(ze, null)),
    !Wr && ze.currentStyle && (Wr = ze.currentStyle),
    Wr || (Wr = ze.style),
    Wr
}
function getTranslate(ze, Gr) {
    ...
    return Wr.WebKitCSSMatrix ? (Yr = Jr.transform || Jr.webkitTransform,
    Yr.split(",").length > 6 && (Yr = Yr.split(", ").map(Zr => Zr.replace(",", ".")).join(", ")),
    Qr = new Wr.WebKitCSSMatrix(Yr === "none" ? "" : Yr)) : (Qr = Jr.MozTransform || Jr.OTransform || Jr.MsTransform || Jr.msTransform || Jr.transform || Jr.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
    Kr = Qr.toString().split(",")),
    ...
    for (let Wr = 1; Wr < arguments.length; Wr += 1) {
        ...
        if (Kr != null && !isNode(Kr)) {
            ...
            for (let Qr = 0, Jr = Yr.length; Qr < Jr; Qr += 1) {
                ...
                ei !== void 0 && ei.enumerable && (isObject(ze[Zr]) && isObject(Kr[Zr]) ? Kr[Zr].__swiper__ ? ze[Zr] = Kr[Zr] : extend(ze[Zr], Kr[Zr]) : !isObject(ze[Zr]) && isObject(Kr[Zr]) ? (ze[Zr] = {},
                Kr[Zr].__swiper__ ? ze[Zr] = Kr[Zr] : extend(ze[Zr], Kr[Zr])) : ze[Zr] = Kr[Zr])
            }
        }
    }
    return ze
...
function animateCSSModeScroll(ze) {
    ...
    Gr.wrapperEl.style.scrollSnapType = "none",
...
function elementChildren(ze, Gr) {
    ...
    return ze instanceof HTMLSlotElement && Wr.push(...ze.assignedElements()),
    Gr ? Wr.filter(Kr => Kr.matches(Gr)) : Wr
}
...
function createElement(ze, Gr) {
    ...
    return Wr.classList.add(...Array.isArray(Gr) ? Gr : classesToTokens(Gr)),
    Wr
}
function elementPrevAll(ze, Gr) {
    ...
    for (; ze.previousElementSibling; ) {
        ...
        Gr ? Kr.matches(Gr) && Wr.push(Kr) : Wr.push(Kr),
        ze = Kr
    }
    return Wr
}
...
function elementIndex(ze) {
    let Gr = ze, Wr;
    if (Gr) {
        for (Wr = 0; (Gr = Gr.previousSibling) !== null; )
            Gr.nodeType === 1 && (Wr += 1);
        return Wr
    }
}
...
function elementOuterSize(ze, Gr, Wr) {
    const Kr = getWindow();
    return ze[Gr === "width" ? "offsetWidth" : "offsetHeight"] + parseFloat(Kr.getComputedStyle(ze, null).getPropertyValue(Gr === "width" ? "margin-right" : "margin-top")) + parseFloat(Kr.getComputedStyle(ze, null).getPropertyValue(Gr === "width" ? "margin-left" : "margin-bottom"))
}
let support;
function calcSupport() {
    const ze = getWindow()
      , Gr = getDocument();
    return {
        smoothScroll: Gr.documentElement && Gr.documentElement.style && "scrollBehavior"in Gr.documentElement.style,
        touch: !!("ontouchstart"in ze || ze.DocumentTouch && Gr instanceof ze.DocumentTouch)
    }
}
function getSupport() {
...
function calcDevice(ze) {
    ...
    return !ri && li && Wr.touch && ui.indexOf(`${Zr}x${ei}`) >= 0 && (ri = Qr.match(/(Version)\/([\d.]+)/),
    ri || (ri = [0, 1, "13_0_0"]),
    li = !1),
    ti && !si && (Jr.os = "android",
    Jr.android = !0),
...
function getDevice(ze) {
    return ze === void 0 && (ze = {}),
    deviceCached || (deviceCached = calcDevice(ze)),
    deviceCached
}
let browser;
...
function Resize(ze) {
    ...
    let Qr = null
      , Jr = null;
    const Zr = () => {
        !Gr || Gr.destroyed || !Gr.initialized || (Kr("beforeResize"),
        Kr("resize"))
    }
      , ei = () => {
        !Gr || Gr.destroyed || !Gr.initialized || (Qr = new ResizeObserver(ii => {
            Jr = Yr.requestAnimationFrame( () => {
                ...
                ii.forEach(oi => {
                    ...
                    ci && ci !== Gr.el || (li = pi ? pi.width : (ai[0] || ai).inlineSize,
                    ui = pi ? pi.height : (ai[0] || ai).blockSize)
                }
                ),
                (li !== ni || ui !== si) && Zr()
            }
      ...
      , ti = () => {
        Jr && Yr.cancelAnimationFrame(Jr),
        Qr && Qr.unobserve && Gr.el && (Qr.unobserve(Gr.el),
        Qr = null)
    }
      , ri = () => {
    ...
    Wr("init", () => {
        ...
        Yr.addEventListener("resize", Zr),
        Yr.addEventListener("orientationchange", ri)
    }
    ),
    Wr("destroy", () => {
        ti(),
        Yr.removeEventListener("resize", Zr),
        Yr.removeEventListener("orientationchange", ri)
    }
    )
}
    ...
    const Qr = []
      ...
      , Zr = function(ri, ii) {
        ...
        si.observe(ri, {
            ...
            childList: Gr.isElement || (typeof ii.childList > "u" ? !0 : ii).childList,
      ...
      , ei = () => {
        if (Gr.params.observer) {
            ...
            Zr(Gr.hostEl, {
                childList: Gr.params.observeSlideChildren
            }),
            Zr(Gr.wrapperEl, {
                attributes: !1
            })
...
var eventsEmitter = {
    on(ze, Gr, Wr) {
        const Kr = this;
        if (!Kr.eventsListeners || Kr.destroyed || typeof Gr != "function")
            return Kr;
        const Yr = Wr ? "unshift" : "push";
        return ze.split(" ").forEach(Qr => {
            Kr.eventsListeners[Qr] || (Kr.eventsListeners[Qr] = []),
            Kr.eventsListeners[Qr][Yr](Gr)
        }
        ),
        Kr
    },
    once(ze, Gr, Wr) {
        ...
        function Yr() {
            Kr.off(ze, Yr),
            Yr.__emitterProxy && delete Yr.__emitterProxy;
            for (var Qr = arguments.length, Jr = new Array(Qr), Zr = 0; Zr < Qr; Zr++)
                Jr[Zr] = arguments[Zr];
            Gr.apply(Kr, Jr)
        }
        return Yr.__emitterProxy = Gr,
        Kr.on(ze, Yr, Wr)
    },
    onAny(ze, Gr) {
        const Wr = this;
        if (!Wr.eventsListeners || Wr.destroyed || typeof ze != "function")
            return Wr;
        const Kr = Gr ? "unshift" : "push";
        return Wr.eventsAnyListeners.indexOf(ze) < 0 && Wr.eventsAnyListeners[Kr](ze),
        Wr
    },
    offAny(ze) {
        const Gr = this;
        if (!Gr.eventsListeners || Gr.destroyed || !Gr.eventsAnyListeners)
            return Gr;
        const Wr = Gr.eventsAnyListeners.indexOf(ze);
        return Wr >= 0 && Gr.eventsAnyListeners.splice(Wr, 1),
        Gr
    },
    off(ze, Gr) {
        const Wr = this;
        return !Wr.eventsListeners || Wr.destroyed || !Wr.eventsListeners || ze.split(" ").forEach(Kr => {
            typeof Gr > "u" ? Wr.eventsListeners[Kr] = [] : Wr.eventsListeners[Kr] && Wr.eventsListeners[Kr].forEach( (Yr, Qr) => {
    ...
    emit() {
        const ze = this;
        if (!ze.eventsListeners || ze.destroyed || !ze.eventsListeners)
            return ze;
        let Gr, Wr, Kr;
        for (var Yr = arguments.length, Qr = new Array(Yr), Jr = 0; Jr < Yr; Jr++)
            Qr[Jr] = arguments[Jr];
        return typeof Qr[0] == "string" || Array.isArray(Qr[0]) ? (Gr = Qr[0],
        Wr = Qr.slice(1, Qr.length),
        Kr = ze) : (Gr = Qr[0].events,
        Wr = Qr[0].data,
        Kr = Qr[0].context || ze),
        Wr.unshift(Kr),
        (Array.isArray(Gr) ? Gr : Gr.split(" ")).forEach(ei => {
            ze.eventsAnyListeners && ze.eventsAnyListeners.length && ze.eventsAnyListeners.forEach(ti => {
                ti.apply(Kr, [ei, ...Wr])
            }
            ),
            ze.eventsListeners && ze.eventsListeners[ei] && ze.eventsListeners[ei].forEach(ti => {
                ti.apply(Kr, Wr)
            }
            )
        }
...
function updateSize() {
    ...
    !(Gr === 0 && ze.isHorizontal() || Wr === 0 && ze.isVertical()) && (Gr = Gr - parseInt(elementStyle(Kr, "padding-left") || 0, 10) - parseInt(elementStyle(Kr, "padding-right") || 0, 10),
...
function updateSlides() {
    ...
    ze.virtualSize = -ci,
    ri.forEach(di => {
        Jr ? di.style.marginLeft = "" : di.style.marginRight = "",
        di.style.marginBottom = "",
        di.style.marginTop = ""
    }
    ),
    Wr.centeredSlides && Wr.cssMode && (setCSSProperty(Kr, "--swiper-centered-offset-before", ""),
    setCSSProperty(Kr, "--swiper-centered-offset-after", ""));
    ...
    for (let di = 0; di < ii; di += 1) {
        ...
        let mi;
        if (ri[di] && (mi = ri[di]),
        bi && ze.grid.updateSlide(di, mi, ri),
        !(ri[di] && elementStyle(mi, "display") === "none")) {
            if (Wr.slidesPerView === "auto") {
                ...
                if (gi && (mi.style.transform = "none"),
                Ti && (mi.style.webkitTransform = "none"),
                Wr.roundLengths)
                    yi = ze.isHorizontal() ? elementOuterSize(mi, "width") : elementOuterSize(mi, "height");
                else {
                ...
                gi && (mi.style.transform = gi),
                Ti && (mi.style.webkitTransform = Ti),
                Wr.roundLengths && (yi = Math.floor(yi))
            } else
                yi = (Qr - (Wr.slidesPerView - 1) * ci) / Wr.slidesPerView,
                Wr.roundLengths && (yi = Math.floor(yi)),
                ri[di] && (ri[di].style[ze.getDirectionLabel("width")] = `${yi}px`);
            ri[di] && (ri[di].swiperSlideSize = yi),
            li.push(yi),
            Wr.centeredSlides ? (hi = hi + yi / 2 + fi / 2 + ci,
            fi === 0 && di !== 0 && (hi = hi - Qr / 2 - ci),
            di === 0 && (hi = hi - Qr / 2 - ci),
            Math.abs(hi) < 1 / 1e3 && (hi = 0),
            Wr.roundLengths && (hi = Math.floor(hi)),
            vi % Wr.slidesPerGroup === 0 && ni.push(hi),
            si.push(hi)) : (Wr.roundLengths && (hi = Math.floor(hi)),
            (vi - Math.min(ze.params.slidesPerGroupSkip, vi)) % ze.params.slidesPerGroup === 0 && ni.push(hi),
            si.push(hi),
            hi = hi + yi + ci),
    ...
    if (ze.virtualSize = Math.max(ze.virtualSize, Qr) + oi,
    ...
    !Wr.centeredSlides) {
        ...
        for (let mi = 0; mi < ni.length; mi += 1) {
            let wi = ni[mi];
            Wr.roundLengths && (wi = Math.floor(wi)),
            ni[mi] <= ze.virtualSize - Qr && di.push(wi)
        }
        ni = di,
        Math.floor(ze.virtualSize - Qr) - Math.floor(ni[ni.length - 1]) > 1 && ni.push(ze.virtualSize - Qr)
    }
    if (ei && Wr.loop) {
        const di = li[0] + ci;
        if (Wr.slidesPerGroup > 1) {
            ...
            for (let gi = 0; gi < mi; gi += 1)
                ni.push(ni[ni.length - 1] + wi)
        }
        for (let mi = 0; mi < ze.virtual.slidesBefore + ze.virtual.slidesAfter; mi += 1)
            Wr.slidesPerGroup === 1 && ni.push(ni[ni.length - 1] + di),
            si.push(si[si.length - 1] + di),
            ze.virtualSize += di
    }
    if (ni.length === 0 && (ni = [0]),
    ci !== 0) {
    ...
    Wr.centeredSlides && Wr.cssMode && !Wr.centeredSlidesBounds) {
        setCSSProperty(Kr, "--swiper-centered-offset-before", `${-ni[0]}px`),
        setCSSProperty(Kr, "--swiper-centered-offset-after", `${ze.size / 2 - li[li.length - 1] / 2}px`);
        const di = -ze.snapGrid[0]
          , mi = -ze.slidesGrid[0];
        ze.snapGrid = ze.snapGrid.map(wi => wi + di),
        ze.slidesGrid = ze.slidesGrid.map(wi => wi + mi)
    }
    if (ii !== ti && ze.emit("slidesLengthChange"),
    ni.length !== ai && (ze.params.watchOverflow && ze.checkOverflow(),
    ze.emit("snapGridLengthChange")),
    ...
    if (Gr.params.slidesPerView !== "auto" && Gr.params.slidesPerView > 1)
        if (Gr.params.centeredSlides)
            ...
            for (Qr = 0; Qr < Math.ceil(Gr.params.slidesPerView); Qr += 1) {
                ...
                if (Zr > Gr.slides.length && !Kr)
                    break;
                Wr.push(Jr(Zr))
            }
    else
        Wr.push(Jr(Gr.activeIndex));
...
function updateSlidesOffset() {
    ...
    for (let Kr = 0; Kr < Gr.length; Kr += 1)
        Gr[Kr].swiperSlideOffset = (ze.isHorizontal() ? Gr[Kr].offsetLeft : Gr[Kr].offsetTop) - Wr - ze.cssOverflowAdjustment()
}
...
function updateSlidesProgress(ze) {
    ...
    for (let ei = 0; ei < Kr.length; ei += 1) {
        ...
        oi && (Gr.visibleSlides.push(ti),
        Gr.visibleSlidesIndexes.push(ei)),
...
function updateProgress(ze) {
    ...
    if (Wr.loop) {
        const ri = Gr.getSlideIndexByData(0)
          ...
          , ui = Math.abs(ze);
        ui >= ni ? Zr = (ui - ni) / li : Zr = (ui + li - si) / li,
        Zr > 1 && (Zr -= 1)
    }
    Object.assign(Gr, {
        progress: Yr,
...
function updateSlidesClasses() {
    ...
    if (Qr)
        if (Wr.loop) {
            ...
            ii < 0 && (ii = ze.virtual.slides.length + ii),
            ii >= ze.virtual.slides.length && (ii -= ze.virtual.slides.length),
            ei = Zr(`[data-swiper-slide-index="${ii}"]`)
        } else
            ei = Zr(`[data-swiper-slide-index="${Yr}"]`);
    else
        Jr ? (ei = Gr.filter(ii => ii.column === Yr)[0],
        ri = Gr.filter(ii => ii.column === Yr + 1)[0],
        ti = Gr.filter(ii => ii.column === Yr - 1)[0]) : ei = Gr[Yr];
    ei && (Jr || (ri = elementNextAll(ei, `.${Wr.slideClass}, swiper-slide`)[0],
    Wr.loop && !ri && (ri = Gr[0]),
    ti = elementPrevAll(ei, `.${Wr.slideClass}, swiper-slide`)[0],
    Wr.loop && !ti === 0 && (ti = Gr[Gr.length - 1]))),
    Gr.forEach(ii => {
        toggleSlideClasses(ii, ii === ei, Wr.slideActiveClass),
        toggleSlideClasses(ii, ii === ri, Wr.slideNextClass),
        toggleSlideClasses(ii, ii === ti, Wr.slidePrevClass)
    }
    ),
    ze.emitSlidesClasses()
}
const processLazyPreloader = (ze, Gr) => {
    if (!ze || ze.destroyed || !ze.params)
        return;
    const Wr = () => ze.isElement ? "swiper-slide" : `.${ze.params.slideClass}`
      , Kr = Gr.closest(Wr());
    if (Kr) {
        let Yr = Kr.querySelector(`.${ze.params.lazyPreloaderClass}`);
        !Yr && ze.isElement && (Kr.shadowRoot ? Yr = Kr.shadowRoot.querySelector(`.${ze.params.lazyPreloaderClass}`) : requestAnimationFrame( () => {
            Kr.shadowRoot && (Yr = Kr.shadowRoot.querySelector(`.${ze.params.lazyPreloaderClass}`),
            Yr && Yr.remove())
        }
        )),
        Yr && Yr.remove()
  ...
  , preload = ze => {
    ...
    if (ze.params.rewind || ze.params.loop)
        ...
        for (let Jr = Math.max(Yr - Gr, 0); Jr <= Math.min(Qr + Gr, Wr - 1); Jr += 1)
            Jr !== Yr && (Jr > Qr || Jr < Yr) && unlazy(ze, Jr)
}
;
function getActiveIndexByTranslate(ze) {
    ...
    let Yr;
    for (let Qr = 0; Qr < Gr.length; Qr += 1)
        typeof Gr[Qr + 1] < "u" ? Kr >= Gr[Qr] && Kr < Gr[Qr + 1] - (Gr[Qr + 1] - Gr[Qr]) / 2 ? Yr = Qr : Kr >= Gr[Qr] && Kr < Gr[Qr + 1] && (Yr = Qr + 1) : Kr >= Gr[Qr] && (Yr = Qr);
    return Wr.normalizeSlideIndex && (Yr < 0 || typeof Yr > "u") && (Yr = 0),
    Yr
}
function updateActiveIndex(ze) {
    ...
    const ri = si => {
        ...
        return li < 0 && (li = Gr.virtual.slides.length + li),
        li >= Gr.virtual.slides.length && (li -= Gr.virtual.slides.length),
        li
    }
    ;
    if (typeof ei > "u" && (ei = getActiveIndexByTranslate(Gr)),
    Kr.indexOf(Wr) >= 0)
        ti = Kr.indexOf(Wr);
    else {
    ...
    if (ti >= Kr.length && (ti = Kr.length - 1),
    ei === Qr && !Gr.params.loop) {
        ti !== Zr && (Gr.snapIndex = ti,
    ...
    let ni;
    if (Gr.virtual && Yr.virtual.enabled && Yr.loop)
        ni = ri(ei);
    else if (ii) {
        const si = Gr.slides.filter(ui => ui.column === ei)[0];
        let li = parseInt(si.getAttribute("data-swiper-slide-index"), 10);
        Number.isNaN(li) && (li = Math.max(Gr.slides.indexOf(si), 0)),
        ni = Math.floor(li / Yr.grid.rows)
    ...
    Gr.emit("snapIndexChange"),
    (Gr.initialized || Gr.params.runCallbacksOnInit) && (Jr !== ni && Gr.emit("realIndexChange"),
    Gr.emit("slideChange"))
}
function updateClickedSlide(ze, Gr) {
    ...
    !Yr && Wr.isElement && Gr && Gr.length > 1 && Gr.includes(ze) && [...Gr.slice(Gr.indexOf(ze) + 1, Gr.length)].forEach(Zr => {
    ...
    if (Yr && Qr)
        Wr.clickedSlide = Yr,
        Wr.virtual && Wr.params.virtual.enabled ? Wr.clickedIndex = parseInt(Yr.getAttribute("data-swiper-slide-index"), 10) : Wr.clickedIndex = Jr;
    else {
        Wr.clickedSlide = void 0,
        Wr.clickedIndex = void 0;
        return
    }
...
function getSwiperTranslate(ze) {
    ...
    if (Wr.virtualTranslate)
        return Kr ? -Yr : Yr;
    if (Wr.cssMode)
        return Yr;
    let Jr = getTranslate(Qr, ze);
    return Jr += Gr.cssOverflowAdjustment(),
    Kr && (Jr = -Jr),
    Jr || 0
}
function setTranslate(ze, Gr) {
    ...
    Yr.roundLengths && (Zr = Math.floor(Zr),
    ei = Math.floor(ei)),
    Wr.previousTranslate = Wr.translate,
    Wr.translate = Wr.isHorizontal() ? Zr : ei,
    Yr.cssMode ? Qr[Wr.isHorizontal() ? "scrollLeft" : "scrollTop"] = Wr.isHorizontal() ? -Zr : -ei : Yr.virtualTranslate || (Wr.isHorizontal() ? Zr -= Wr.cssOverflowAdjustment() : ei -= Wr.cssOverflowAdjustment(),
    Qr.style.transform = `translate3d(${Zr}px, ${ei}px, ${ti}px)`);
    let ri;
    const ii = Wr.maxTranslate() - Wr.minTranslate();
    ii === 0 ? ri = 0 : ri = (ze - Wr.minTranslate()) / ii,
    ri !== Jr && Wr.updateProgress(ze),
    Wr.emit("setTranslate", Wr.translate, Gr)
}
...
function translateTo(ze, Gr, Wr, Kr, Yr) {
    ze === void 0 && (ze = 0),
    Gr === void 0 && (Gr = this.params.speed),
    Wr === void 0 && (Wr = !0),
    Kr === void 0 && (Kr = !0);
    const Qr = this
    ...
    const ei = Qr.minTranslate()
      , ti = Qr.maxTranslate();
    let ri;
    if (Kr && ze > ei ? ri = ei : Kr && ze < ti ? ri = ti : ri = ze,
    ...
    return Gr === 0 ? (Qr.setTransition(0),
    Qr.setTranslate(ri),
    Wr && (Qr.emit("beforeTransitionStart", Gr, Yr),
    Qr.emit("transitionEnd"))) : (Qr.setTransition(Gr),
    Qr.setTranslate(ri),
    Wr && (Qr.emit("beforeTransitionStart", Gr, Yr),
...
function setTransition(ze, Gr) {
    const Wr = this;
    Wr.params.cssMode || (Wr.wrapperEl.style.transitionDuration = `${ze}ms`,
    Wr.wrapperEl.style.transitionDelay = ze === 0 ? "0ms" : ""),
    Wr.emit("setTransition", ze, Gr)
}
function transitionEmit(ze) {
    let {swiper: Gr, runCallbacks: Wr, direction: Kr, step: Yr} = ze;
    const {activeIndex: Qr, previousIndex: Jr} = Gr;
    let Zr = Kr;
    if (Zr || (Qr > Jr ? Zr = "next" : Qr < Jr ? Zr = "prev" : Zr = "reset"),
    Gr.emit(`transition${Yr}`),
    Wr && Qr !== Jr) {
        if (Zr === "reset") {
            Gr.emit(`slideResetTransition${Yr}`);
            return
        }
        Gr.emit(`slideChangeTransition${Yr}`),
        Zr === "next" ? Gr.emit(`slideNextTransition${Yr}`) : Gr.emit(`slidePrevTransition${Yr}`)
    }
}
function transitionStart(ze, Gr) {
    ...
    const Wr = this
      , {params: Kr} = Wr;
    Kr.cssMode || (Kr.autoHeight && Wr.updateAutoHeight(),
    transitionEmit({
        swiper: Wr,
        runCallbacks: ze,
        direction: Gr,
...
function slideTo(ze, Gr, Wr, Kr, Yr) {
    ...
    if (!li && !Kr && !Yr || Qr.destroyed || Qr.animating && Zr.preventInteractionOnTransition)
        return !1;
    ...
    if (Qr.initialized && Jr !== ii && (!Qr.allowSlideNext && (ni ? ai > Qr.translate && ai > Qr.minTranslate() : ai < Qr.translate && ai < Qr.minTranslate()) || !Qr.allowSlidePrev && ai > Qr.translate && ai > Qr.maxTranslate() && (ii || 0) !== Jr))
        return !1;
    Jr !== (ri || 0) && Wr && Qr.emit("beforeSlideChangeStart"),
    Qr.updateProgress(ai);
    let pi;
    ...
    if (!(ci && Yr) && (ni && -ai === Qr.translate || !ni && ai === Qr.translate))
        ...
        Zr.effect !== "slide" && Qr.setTranslate(ai),
        pi !== "reset" && (Qr.transitionStart(Wr, pi),
    ...
    if (Zr.cssMode) {
        const fi = Qr.isHorizontal()
          , vi = ni ? ai : -ai;
        if (Gr === 0)
            ci && (Qr.wrapperEl.style.scrollSnapType = "none",
            Qr._immediateVirtual = !0),
            ci && !Qr._cssModeVirtualInitialSet && Qr.params.initialSlide > 0 ? (Qr._cssModeVirtualInitialSet = !0,
            requestAnimationFrame( () => {
    ...
    return Qr.setTransition(Gr),
    Qr.setTranslate(ai),
    Qr.updateActiveIndex(Jr),
    Qr.updateSlidesClasses(),
    Qr.emit("beforeTransitionStart", Gr, Kr),
    Qr.transitionStart(Wr, pi),
    Gr === 0 ? Qr.transitionEnd(Wr, pi) : Qr.animating || (Qr.animating = !0,
    Qr.onSlideToWrapperTransitionEnd || (Qr.onSlideToWrapperTransitionEnd = function(vi) {
        !Qr || Qr.destroyed || vi.target === this && (Qr.wrapperEl.removeEventListener("transitionend", Qr.onSlideToWrapperTransitionEnd),
...
function slideToLoop(ze, Gr, Wr, Kr) {
    ...
    let Jr = ze;
    if (Yr.params.loop)
        if (Yr.virtual && Yr.params.virtual.enabled)
            Jr = Jr + Yr.virtual.slidesBefore;
        else {
            let Zr;
            if (Qr) {
            ...
            ri === "auto" ? ri = Yr.slidesPerViewDynamic() : (ri = Math.ceil(parseFloat(Yr.params.slidesPerView, 10)),
            ti && ri % 2 === 0 && (ri = ri + 1));
            let ii = ei - Zr < ri;
            if (ti && (ii = ii || Zr < Math.ceil(ri / 2)),
            Kr && ti && Yr.params.slidesPerView !== "auto" && !Qr && (ii = !1),
            ii) {
                ...
                Yr.loopFix({
                    ...
                    slideRealIndex: ni === "next" ? Yr.realIndex : void 0
                })
            }
            if (Qr) {
                const ni = Jr * Yr.params.grid.rows;
...
function slideNext(ze, Gr, Wr) {
    ...
    if (Qr.loop) {
        ...
        Kr._clientLeft = Kr.wrapperEl.clientLeft,
        Kr.activeIndex === Kr.slides.length - 1 && Qr.cssMode)
            return requestAnimationFrame( () => {
...
function slidePrev(ze, Gr, Wr) {
    ...
    if (Yr.loop) {
        if (ti && !ri && Yr.loopPreventsSliding)
            return !1;
        Kr.loopFix({
            direction: "prev"
        }),
    ...
    let oi = 0;
    if (typeof ui < "u" && (oi = Jr.indexOf(ui),
    oi < 0 && (oi = Kr.activeIndex - 1),
    Yr.slidesPerView === "auto" && Yr.slidesPerGroup === 1 && Yr.slidesPerGroupAuto && (oi = oi - Kr.slidesPerViewDynamic("previous", !0) + 1,
    oi = Math.max(oi, 0))),
...
function slideReset(ze, Gr, Wr) {
    ...
    const Kr = this;
    if (!Kr.destroyed)
        return typeof ze > "u" && (ze = Kr.params.speed),
        Kr.slideTo(Kr.activeIndex, ze, Gr, Wr)
}
function slideToClosest(ze, Gr, Wr, Kr) {
    ...
    Qr = Math.min(Qr, Yr.slidesGrid.length - 1),
    Yr.slideTo(Qr, ze, Gr, Wr)
}
...
function loopCreate(ze) {
    ...
    if (!Wr.loop || Gr.virtual && Gr.params.virtual.enabled)
        return;
    const Yr = () => {
    ...
    Gr.loopFix({
        slideRealIndex: ze,
        direction: Wr.centeredSlides ? void 0 : "next"
    })
}
function loopFix(ze) {
    ...
    if (ei.allowSlidePrev = !0,
    ei.allowSlideNext = !0,
    ei.virtual && si.virtual.enabled) {
        Wr && (!si.centeredSlides && ei.snapIndex === 0 ? ei.slideTo(ei.virtual.slides.length, 0, !1, !0) : si.centeredSlides && ei.snapIndex < si.slidesPerView ? ei.slideTo(ei.virtual.slides.length + ei.snapIndex, 0, !1, !0) : ei.snapIndex === ei.snapGrid.length - 1 && ei.slideTo(ei.virtual.slidesBefore, 0, !1, !0)),
    ...
    ui === "auto" ? ui = ei.slidesPerViewDynamic() : (ui = Math.ceil(parseFloat(si.slidesPerView, 10)),
    li && ui % 2 === 0 && (ui = ui + 1));
    ...
    ti.length < ui + ai ? showWarning("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : pi && si.grid.fill === "row" && showWarning("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
    const ci = []
      , hi = [];
    ...
    const di = pi ? Math.ceil(ti.length / si.grid.rows) : ti.length
      , wi = (pi ? ti[Qr].column : Qr) + (li && typeof Yr > "u" ? -ui / 2 + .5 : 0);
    if (wi < ai) {
        ...
        for (let gi = 0; gi < ai - wi; gi += 1) {
            ...
            if (pi) {
                const xi = di - Ti - 1;
                for (let Mi = ti.length - 1; Mi >= 0; Mi -= 1)
                    ti[Mi].column === xi && ci.push(Mi)
            } else
                ci.push(di - Ti - 1)
        }
    } else if (wi + ui > di - ai) {
    ...
    if (ei.__preventObserver__ = !0,
    requestAnimationFrame( () => {
        ei.__preventObserver__ = !1
    }
    ),
    bi && ci.forEach(gi => {
        ti[gi].swiperLoopMoveDOM = !0,
        ni.prepend(ti[gi]),
        ti[gi].swiperLoopMoveDOM = !1
    }
    ),
    vi && hi.forEach(gi => {
        ti[gi].swiperLoopMoveDOM = !0,
    ...
    ei.recalcSlides(),
    si.slidesPerView === "auto" ? ei.updateSlides() : pi && (ci.length > 0 && bi || hi.length > 0 && vi) && ei.slides.forEach( (gi, Ti) => {
    ...
    Wr) {
        if (ci.length > 0 && bi) {
            if (typeof Gr > "u") {
                ...
                Zr ? ei.setTranslate(ei.translate - xi) : (ei.slideTo(fi + Math.ceil(yi), 0, !1, !0),
                Yr && (ei.touchEventsData.startTranslate = ei.touchEventsData.startTranslate - xi,
                ei.touchEventsData.currentTranslate = ei.touchEventsData.currentTranslate - xi))
            } else if (Yr) {
            ...
            if (typeof Gr > "u") {
                ...
                Zr ? ei.setTranslate(ei.translate - xi) : (ei.slideTo(fi - Ei, 0, !1, !0),
                Yr && (ei.touchEventsData.startTranslate = ei.touchEventsData.startTranslate - xi,
                ei.touchEventsData.currentTranslate = ei.touchEventsData.currentTranslate - xi))
            } else {
    ...
    ei.controller && ei.controller.control && !Jr) {
        ...
        Array.isArray(ei.controller.control) ? ei.controller.control.forEach(Ti => {
            !Ti.destroyed && Ti.params.loop && Ti.loopFix({
                ...gi,
                slideTo: Ti.params.slidesPerView === si.slidesPerView ? Wr : !1
            })
        }
        ) : ei.controller.control instanceof ei.constructor && ei.controller.control.params.loop && ei.controller.control.loopFix({
            ...gi,
            slideTo: ei.controller.control.params.slidesPerView === si.slidesPerView ? Wr : !1
        })
    }
    ei.emit("loopFix")
}
function loopDestroy() {
    ...
    if (!Gr.loop || ze.virtual && ze.params.virtual.enabled)
        return;
    ze.recalcSlides();
    const Kr = [];
...
function setGrabCursor(ze) {
    const Gr = this;
    if (!Gr.params.simulateTouch || Gr.params.watchOverflow && Gr.isLocked || Gr.params.cssMode)
        return;
    ...
    Gr.isElement && requestAnimationFrame( () => {
...
function unsetGrabCursor() {
    const ze = this;
    ze.params.watchOverflow && ze.isLocked || ze.params.cssMode || (ze.isElement && (ze.__preventObserver__ = !0),
...
function closestElement(ze, Gr) {
    Gr === void 0 && (Gr = this);
    function Wr(Kr) {
        if (!Kr || Kr === getDocument() || Kr === getWindow())
            return null;
...
function preventEdgeSwipe(ze, Gr, Wr) {
    ...
    return Qr && (Wr <= Jr || Wr >= Kr.innerWidth - Jr) ? Qr === "prevent" ? (Gr.preventDefault(),
    !0) : !1 : !0
}
function onTouchStart(ze) {
    ...
    if (Kr.type === "pointerdown") {
        if (Yr.pointerId !== null && Yr.pointerId !== Kr.pointerId)
            return;
        Yr.pointerId = Kr.pointerId
    } else
        Kr.type === "touchstart" && Kr.targetTouches.length === 1 && (Yr.touchId = Kr.targetTouches[0].identifier);
    if (Kr.type === "touchstart") {
        preventEdgeSwipe(Gr, Kr, Kr.targetTouches[0].pageX);
        return
    }
    const {params: Qr, touches: Jr, enabled: Zr} = Gr;
    if (!Zr || !Qr.simulateTouch && Kr.pointerType === "mouse" || Gr.animating && Qr.preventInteractionOnTransition)
        return;
    !Gr.animating && Qr.cssMode && Qr.loop && Gr.loopFix();
    let ei = Kr.target;
    if (Qr.touchEventsTarget === "wrapper" && !elementIsChildOf(ei, Gr.wrapperEl) || "which"in Kr && Kr.which === 3 || "button"in Kr && Kr.button > 0 || Yr.isTouched && Yr.isMoved)
        return;
    ...
    if (Qr.swipeHandler && !ei.closest(Qr.swipeHandler))
        return;
    Jr.currentX = Kr.pageX,
    Jr.currentY = Kr.pageY;
    const si = Jr.currentX
      , li = Jr.currentY;
    if (!preventEdgeSwipe(Gr, Kr, si))
        return;
    Object.assign(Yr, {
        isTouched: !0,
        isMoved: !1,
    ...
    let ui = !0;
    ei.matches(Yr.focusableElements) && (ui = !1,
    ei.nodeName === "SELECT" && (Yr.isTouched = !1)),
    Wr.activeElement && Wr.activeElement.matches(Yr.focusableElements) && Wr.activeElement !== ei && Wr.activeElement.blur();
    const oi = ui && Gr.allowTouchMove && Qr.touchStartPreventDefault;
    (Qr.touchStartForcePreventDefault || oi) && !ei.isContentEditable && Kr.preventDefault(),
    Qr.freeMode && Qr.freeMode.enabled && Gr.freeMode && Gr.animating && !Qr.cssMode && Gr.freeMode.onTouchStart(),
    Gr.emit("touchStart", Kr)
}
function onTouchMove(ze) {
    ...
    if (!Zr || !Yr.simulateTouch && ze.pointerType === "mouse")
        return;
    let ei = ze;
    if (ei.originalEvent && (ei = ei.originalEvent),
    ei.type === "pointermove" && (Kr.touchId !== null || ei.pointerId !== Kr.pointerId))
        return;
    let ti;
    if (ei.type === "touchmove") {
        if (ti = [...ei.changedTouches].filter(vi => vi.identifier === Kr.touchId)[0],
        !ti || ti.identifier !== Kr.touchId)
            return
    } else
        ti = ei;
    if (!Kr.isTouched) {
    ...
    if (!Wr.allowTouchMove) {
        ei.target.matches(Kr.focusableElements) || (Wr.allowClick = !1),
        Kr.isTouched && (Object.assign(Qr, {
            startX: ri,
            startY: ii,
            currentX: ri,
            currentY: ii
    ...
    if (Yr.touchReleaseOnEdges && !Yr.loop) {
        ...
        } else if (ri < Qr.startX && Wr.translate <= Wr.maxTranslate() || ri > Qr.startX && Wr.translate >= Wr.minTranslate())
            return
    }
    ...
    Kr.allowTouchCallbacks && Wr.emit("touchMove", ei),
    ...
    if (Wr.params.threshold && Math.sqrt(ni ** 2 + si ** 2) < Wr.params.threshold)
        return;
    if (typeof Kr.isScrolling > "u") {
        let vi;
        Wr.isHorizontal() && Qr.currentY === Qr.startY || Wr.isVertical() && Qr.currentX === Qr.startX ? Kr.isScrolling = !1 : ni * ni + si * si >= 25 && (vi = Math.atan2(Math.abs(si), Math.abs(ni)) * 180 / Math.PI,
        Kr.isScrolling = Wr.isHorizontal() ? vi > Yr.touchAngle : 90 - vi > Yr.touchAngle)
    }
    if (Kr.isScrolling && Wr.emit("touchMoveOpposite", ei),
    ...
    if (!Kr.startMoving)
        return;
    Wr.allowClick = !1,
    !Yr.cssMode && ei.cancelable && ei.preventDefault(),
    Yr.touchMoveStopPropagation && !Yr.nested && ei.stopPropagation();
    let li = Wr.isHorizontal() ? ni : si
      , ui = Wr.isHorizontal() ? Qr.currentX - Qr.previousX : Qr.currentY - Qr.previousY;
    Yr.oneWayMovement && (li = Math.abs(li) * (Jr ? 1 : -1),
    ui = Math.abs(ui) * (Jr ? 1 : -1)),
    Qr.diff = li,
    li *= Yr.touchRatio,
    Jr && (li = -li,
    ui = -ui);
    const oi = Wr.touchesDirection;
    Wr.swipeDirection = li > 0 ? "prev" : "next",
    Wr.touchesDirection = ui > 0 ? "prev" : "next";
    ...
    if (!Kr.isMoved) {
        if (ai && pi && Wr.loopFix({
            direction: Wr.swipeDirection
        }),
        Kr.startTranslate = Wr.getTranslate(),
        Wr.setTransition(0),
        Wr.animating) {
            const vi = new window.CustomEvent("transitionend",{
                bubbles: !0,
                cancelable: !0,
                detail: {
                    bySwiperTouchMove: !0
        ...
        Kr.allowMomentumBounce = !1,
        Yr.grabCursor && (Wr.allowSlideNext === !0 || Wr.allowSlidePrev === !0) && Wr.setGrabCursor(!0),
        Wr.emit("sliderFirstMove", ei)
    }
    let ci;
    if (new Date().getTime(),
    Kr.isMoved && Kr.allowThresholdMove && oi !== Wr.touchesDirection && ai && pi && Math.abs(li) >= 1) {
        Object.assign(Qr, {
            startX: ri,
            startY: ii,
            currentX: ri,
            currentY: ii,
            startTranslate: Kr.currentTranslate
        }),
        Kr.loopSwapReset = !0,
        Kr.startTranslate = Kr.currentTranslate;
        return
    }
    Wr.emit("sliderMove", ei),
    Kr.isMoved = !0,
    Kr.currentTranslate = li + Kr.startTranslate;
    let hi = !0
      , fi = Yr.resistanceRatio;
    if (Yr.touchReleaseOnEdges && (fi = 0),
    li > 0 ? (ai && pi && !ci && Kr.allowThresholdMove && Kr.currentTranslate > (Yr.centeredSlides ? Wr.minTranslate() - Wr.slidesSizesGrid[Wr.activeIndex + 1] - (Yr.slidesPerView !== "auto" && Wr.slides.length - Yr.slidesPerView >= 2 ? Wr.slidesSizesGrid[Wr.activeIndex + 1] + Wr.params.spaceBetween : 0) - Wr.params.spaceBetween : Wr.minTranslate()) && Wr.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    Kr.currentTranslate > Wr.minTranslate() && (hi = !1,
    Yr.resistance && (Kr.currentTranslate = Wr.minTranslate() - 1 + (-Wr.minTranslate() + Kr.startTranslate + li) ** fi))) : li < 0 && (ai && pi && !ci && Kr.allowThresholdMove && Kr.currentTranslate < (Yr.centeredSlides ? Wr.maxTranslate() + Wr.slidesSizesGrid[Wr.slidesSizesGrid.length - 1] + Wr.params.spaceBetween + (Yr.slidesPerView !== "auto" && Wr.slides.length - Yr.slidesPerView >= 2 ? Wr.slidesSizesGrid[Wr.slidesSizesGrid.length - 1] + Wr.params.spaceBetween : 0) : Wr.maxTranslate()) && Wr.loopFix({
        direction: "next",
        setTranslate: !0,
        activeSlideIndex: Wr.slides.length - (Yr.slidesPerView === "auto" ? Wr.slidesPerViewDynamic() : Math.ceil(parseFloat(Yr.slidesPerView, 10)))
    }),
    Kr.currentTranslate < Wr.maxTranslate() && (hi = !1,
    Yr.resistance && (Kr.currentTranslate = Wr.maxTranslate() + 1 - (Wr.maxTranslate() - Kr.startTranslate - li) ** fi))),
    ...
    Yr.threshold > 0)
        if (Math.abs(li) > Yr.threshold || Kr.allowThresholdMove) {
            if (!Kr.allowThresholdMove) {
                Kr.allowThresholdMove = !0,
                Qr.startX = Qr.currentX,
                Qr.startY = Qr.currentY,
                Kr.currentTranslate = Kr.startTranslate,
                Qr.diff = Wr.isHorizontal() ? Qr.currentX - Qr.startX : Qr.currentY - Qr.startY;
                return
            }
        } else {
            Kr.currentTranslate = Kr.startTranslate;
    ...
    !Yr.followFinger || Yr.cssMode || ((Yr.freeMode && Yr.freeMode.enabled && Wr.freeMode || Yr.watchSlidesProgress) && (Wr.updateActiveIndex(),
...
function onTouchEnd(ze) {
    ...
    if (Kr.type === "touchend" || Kr.type === "touchcancel") {
        if (Yr = [...Kr.changedTouches].filter(fi => fi.identifier === Wr.touchId)[0],
        !Yr || Yr.identifier !== Wr.touchId)
            return
    } else {
        if (Wr.touchId !== null || Kr.pointerId !== Wr.pointerId)
            return;
        Yr = Kr
    }
    if (["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(Kr.type) && !(["pointercancel", "contextmenu"].includes(Kr.type) && (Gr.browser.isSafari || Gr.browser.isWebView)))
        return;
    Wr.pointerId = null,
    Wr.touchId = null;
    const {params: Jr, touches: Zr, rtlTranslate: ei, slidesGrid: ti, enabled: ri} = Gr;
    if (!ri || !Jr.simulateTouch && Kr.pointerType === "mouse")
        return;
    if (Wr.allowTouchCallbacks && Gr.emit("touchEnd", Kr),
    Wr.allowTouchCallbacks = !1,
    !Wr.isTouched) {
        Wr.isMoved && Jr.grabCursor && Gr.setGrabCursor(!1),
        Wr.isMoved = !1,
        Wr.startMoving = !1;
        return
    }
    ...
    if (Gr.allowClick) {
        ...
        Gr.updateClickedSlide(fi && fi[0] || Kr.target, fi),
        Gr.emit("tap click", Kr),
        ni < 300 && ii - Wr.lastClickTime < 300 && Gr.emit("doubleTap doubleClick", Kr)
    }
    if (Wr.lastClickTime = now(),
    nextTick( () => {
    ...
    Wr.startMoving = !1;
    let si;
    if (Jr.followFinger ? si = ei ? Gr.translate : -Gr.translate : si = -Wr.currentTranslate,
    Jr.cssMode)
        return;
    if (Jr.freeMode && Jr.freeMode.enabled) {
        Gr.freeMode.onTouchEnd({
            currentPos: si
        });
        return
    }
    ...
    for (let fi = 0; fi < ti.length; fi += fi < Jr.slidesPerGroupSkip ? 1 : Jr.slidesPerGroup) {
        ...
        typeof ti[fi + vi] < "u" ? (li || si >= ti[fi] && si < ti[fi + vi]) && (ui = fi,
        oi = ti[fi + vi] - ti[fi]) : (li || si >= ti[fi]) && (ui = fi,
        oi = ti[ti.length - 1] - ti[ti.length - 2])
    }
    let ai = null
      , pi = null;
    ...
    if (ni > Jr.longSwipesMs) {
        ...
        Gr.navigation && (Kr.target === Gr.navigation.nextEl || Kr.target === Gr.navigation.prevEl) ? Kr.target === Gr.navigation.nextEl ? Gr.slideTo(ui + hi) : Gr.slideTo(ui) : (Gr.swipeDirection === "next" && Gr.slideTo(ai !== null ? ai : ui + hi),
        Gr.swipeDirection === "prev" && Gr.slideTo(pi !== null ? pi : ui))
    }
}
function onResize() {
    const ze = this
      , {params: Gr, el: Wr} = ze;
    if (Wr && Wr.offsetWidth === 0)
        return;
    ...
    const Zr = Jr && Gr.loop;
    (Gr.slidesPerView === "auto" || Gr.slidesPerView > 1) && ze.isEnd && !ze.isBeginning && !ze.params.centeredSlides && !Zr ? ze.slideTo(ze.slides.length - 1, 0, !1, !0) : ze.params.loop && !Jr ? ze.slideToLoop(ze.realIndex, 0, !1, !0) : ze.slideTo(ze.activeIndex, 0, !1, !0),
    ze.autoplay && ze.autoplay.running && ze.autoplay.paused && (clearTimeout(ze.autoplay.resizeTimeout),
...
function onClick(ze) {
    const Gr = this;
    Gr.enabled && (Gr.allowClick || (Gr.params.preventClicks && ze.preventDefault(),
    Gr.params.preventClicksPropagation && Gr.animating && (ze.stopPropagation(),
    ze.stopImmediatePropagation())))
}
function onScroll() {
    const ze = this
    ...
    if (!Kr)
        return;
    ze.previousTranslate = ze.translate,
    ze.isHorizontal() ? ze.translate = -Gr.scrollLeft : ze.translate = -Gr.scrollTop,
    ze.translate === 0 && (ze.translate = 0),
    ze.updateActiveIndex(),
    ze.updateSlidesClasses();
    let Yr;
    const Qr = ze.maxTranslate() - ze.minTranslate();
    Qr === 0 ? Yr = 0 : Yr = (ze.translate - ze.minTranslate()) / Qr,
    Yr !== ze.progress && ze.updateProgress(Wr ? -ze.translate : ze.translate),
    ze.emit("setTranslate", ze.translate, !1)
}
function onLoad(ze) {
    const Gr = this;
    processLazyPreloader(Gr, ze.target),
    !(Gr.params.cssMode || Gr.params.slidesPerView !== "auto" && !Gr.params.autoHeight) && Gr.update()
}
function onDocumentTouchStart() {
    const ze = this;
    ze.documentTouchHandlerProceeded || (ze.documentTouchHandlerProceeded = !0,
    ze.params.touchReleaseOnEdges && (ze.el.style.touchAction = "auto"))
}
const events = (ze, Gr) => {
    const Wr = getDocument()
      ...
      , ti = Gr;
    !Yr || typeof Yr == "string" || (Wr[ei]("touchstart", ze.onDocumentTouchStart, {
        passive: !1,
        capture: Zr
    }),
    Yr[ei]("touchstart", ze.onTouchStart, {
        passive: !1
    }),
    Yr[ei]("pointerdown", ze.onTouchStart, {
        passive: !1
    }),
    Wr[ei]("touchmove", ze.onTouchMove, {
        passive: !1,
        capture: Zr
    }),
    Wr[ei]("pointermove", ze.onTouchMove, {
        passive: !1,
        capture: Zr
    }),
    Wr[ei]("touchend", ze.onTouchEnd, {
        passive: !0
    }),
    Wr[ei]("pointerup", ze.onTouchEnd, {
        passive: !0
    }),
    Wr[ei]("pointercancel", ze.onTouchEnd, {
        passive: !0
    }),
    Wr[ei]("touchcancel", ze.onTouchEnd, {
        passive: !0
    }),
    Wr[ei]("pointerout", ze.onTouchEnd, {
        passive: !0
    }),
    Wr[ei]("pointerleave", ze.onTouchEnd, {
        passive: !0
    }),
    Wr[ei]("contextmenu", ze.onTouchEnd, {
        passive: !0
    }),
...
function setBreakpoint() {
    ...
    const ei = (Jr in Qr ? Qr[Jr] : void 0) || ze.originalParams
      ...
      , ni = ei.grabCursor
      , si = Kr.enabled;
    ti && !ri ? (Yr.classList.remove(`${Kr.containerModifierClass}grid`, `${Kr.containerModifierClass}grid-column`),
    ze.emitContainerClasses()) : !ti && ri && (Yr.classList.add(`${Kr.containerModifierClass}grid`),
    ...
    const li = ei.direction && ei.direction !== Kr.direction
      ...
      , oi = Kr.loop;
    li && Wr && ze.changeDirection(),
    extend(ze.params, ei);
    const ai = ze.params.enabled
      , pi = ze.params.loop;
    Object.assign(ze, {
        allowTouchMove: ze.params.allowTouchMove,
        allowSlideNext: ze.params.allowSlideNext,
        allowSlidePrev: ze.params.allowSlidePrev
    }),
    si && !ai ? ze.disable() : !si && ai && ze.enable(),
    ze.currentBreakpoint = Jr,
    ze.emit("_beforeBreakpoint", ei),
    Wr && (ui ? (ze.loopDestroy(),
    ze.loopCreate(Gr),
    ze.updateSlides()) : !oi && pi ? (ze.loopCreate(Gr),
    ze.updateSlides()) : oi && !pi && ze.loopDestroy()),
    ze.emit("breakpoint", ei)
}
function getBreakpoint(ze, Gr, Wr) {
    if (Gr === void 0 && (Gr = "window"),
    !ze || Gr === "container" && !Wr)
        return;
    let Kr = !1;
    const Yr = getWindow()
...
function prepareClasses(ze, Gr) {
    const Wr = [];
    return ze.forEach(Kr => {
        typeof Kr == "object" ? Object.keys(Kr).forEach(Yr => {
            Kr[Yr] && Wr.push(Gr + Yr)
        }
...
function addClasses() {
    const ze = this
      ...
      , Jr = prepareClasses(["initialized", Wr.direction, {
...
function removeClasses() {
    ...
    !Gr || typeof Gr == "string" || (Gr.classList.remove(...Wr),
    ze.emitContainerClasses())
}
var classes = {
    addClasses,
...
function checkOverflow() {
    ...
    if (Kr) {
        ...
        ze.isLocked = ze.snapGrid.length === 1;
    Wr.allowSlideNext === !0 && (ze.allowSlideNext = !ze.isLocked),
    Wr.allowSlidePrev === !0 && (ze.allowSlidePrev = !ze.isLocked),
    Gr && Gr !== ze.isLocked && (ze.isEnd = !1),
    Gr !== ze.isLocked && ze.emit(ze.isLocked ? "lock" : "unlock")
}
var checkOverflow$1 = {
    checkOverflow
}
...
function moduleExtendParams(ze, Gr) {
    return function(Kr) {
        ...
        typeof ze[Yr] == "object" && !("enabled"in ze[Yr]) && (ze[Yr].enabled = !0),
        ze[Yr] || (ze[Yr] = {
            enabled: !1
        }),
        extend(Gr, Kr)
...
class Swiper {
    constructor() {
        let Gr, Wr;
        for (var Kr = arguments.length, Yr = new Array(Kr), Qr = 0; Qr < Kr; Qr++)
            Yr[Qr] = arguments[Qr];
        Yr.length === 1 && Yr[0].constructor && Object.prototype.toString.call(Yr[0]).slice(8, -1) === "Object" ? Wr = Yr[0] : [Gr,Wr] = Yr,
        Wr || (Wr = {}),
        Wr = extend({}, Wr),
        Gr && !Wr.el && (Wr.el = Gr);
        ...
        if (Wr.el && typeof Wr.el == "string" && Jr.querySelectorAll(Wr.el).length > 1) {
            const ri = [];
            return Jr.querySelectorAll(Wr.el).forEach(ii => {
                const ni = extend({}, Wr, {
                    el: ii
                });
        ...
        Zr.modules.forEach(ri => {
            ri({
                params: Wr,
                swiper: Zr,
                extendParams: moduleExtendParams(Wr, ei),
                on: Zr.on.bind(Zr),
        ...
        return Zr.params = extend({}, ti, extendedDefaults, Wr),
    ...
    enable() {
        const Gr = this;
        Gr.enabled || (Gr.enabled = !0,
        Gr.params.grabCursor && Gr.setGrabCursor(),
        Gr.emit("enable"))
    }
    disable() {
        const Gr = this;
        Gr.enabled && (Gr.enabled = !1,
        Gr.params.grabCursor && Gr.unsetGrabCursor(),
        Gr.emit("disable"))
    }
    setProgress(Gr, Wr) {
        const Kr = this;
        ...
        Kr.translateTo(Jr, typeof Wr > "u" ? 0 : Wr),
        Kr.updateActiveIndex(),
        Kr.updateSlidesClasses()
    }
    emitContainerClasses() {
        const Gr = this;
        if (!Gr.params._emitClasses || !Gr.el)
            return;
    ...
    getSlideClasses(Gr) {
        const Wr = this;
        return Wr.destroyed ? "" : Gr.className.split(" ").filter(Kr => Kr.indexOf("swiper-slide") === 0 || Kr.indexOf(Wr.params.slideClass) === 0).join(" ")
    }
    emitSlidesClasses() {
        const Gr = this;
        if (!Gr.params._emitClasses || !Gr.el)
    ...
    slidesPerViewDynamic(Gr, Wr) {
        ...
        if (Yr.centeredSlides) {
            ...
            for (let ii = ti + 1; ii < Qr.length; ii += 1)
                (Wr ? Jr[ii] + Zr[ii] - Jr[ti] < ei : Jr[ii] - Jr[ti] < ei) && (ri += 1);
        else
    ...
    update() {
        ...
        function Yr() {
            ...
            Gr.setTranslate(Zr),
            Gr.updateActiveIndex(),
            Gr.updateSlidesClasses()
        }
        let Qr;
        if (Kr.freeMode && Kr.freeMode.enabled && !Kr.cssMode)
            Yr(),
            Kr.autoHeight && Gr.updateAutoHeight();
        else {
            if ((Kr.slidesPerView === "auto" || Kr.slidesPerView > 1) && Gr.isEnd && !Kr.centeredSlides) {
                ...
                Qr = Gr.slideTo(Gr.activeIndex, 0, !1, !0);
            Qr || Yr()
        }
        Kr.watchOverflow && Wr !== Gr.snapGrid && Gr.checkOverflow(),
        Gr.emit("update")
    }
    changeDirection(Gr, Wr) {
        ...
        return Gr || (Gr = Yr === "horizontal" ? "vertical" : "horizontal"),
        Gr === Yr || Gr !== "horizontal" && Gr !== "vertical" || (Kr.el.classList.remove(`${Kr.params.containerModifierClass}${Yr}`),
    ...
    changeLanguageDirection(Gr) {
        const Wr = this;
        Wr.rtl && Gr === "rtl" || !Wr.rtl && Gr === "ltr" || (Wr.rtl = Gr === "rtl",
        Wr.rtlTranslate = Wr.params.direction === "horizontal" && Wr.rtl,
        Wr.rtl ? (Wr.el.classList.add(`${Wr.params.containerModifierClass}rtl`),
        Wr.el.dir = "rtl") : (Wr.el.classList.remove(`${Wr.params.containerModifierClass}rtl`),
        Wr.el.dir = "ltr"),
        Wr.update())
    }
    mount(Gr) {
        ...
        if (typeof Kr == "string" && (Kr = document.querySelector(Kr)),
        !Kr)
            return !1;
        Kr.swiper = Wr,
        Kr.parentNode && Kr.parentNode.host && Kr.parentNode.host.nodeName === Wr.params.swiperElementNodeName.toUpperCase() && (Wr.isElement = !0);
        ...
        return !Jr && Wr.params.createElements && (Jr = createElement("div", Wr.params.wrapperClass),
        Kr.append(Jr),
    ...
    init(Gr) {
        const Wr = this;
        if (Wr.initialized || Wr.mount(Gr) === !1)
            return Wr;
        Wr.emit("beforeInit"),
        ...
        Wr.params.loop && Wr.virtual && Wr.params.virtual.enabled ? Wr.slideTo(Wr.params.initialSlide + Wr.virtual.slidesBefore, 0, Wr.params.runCallbacksOnInit, !1, !0) : Wr.slideTo(Wr.params.initialSlide, 0, Wr.params.runCallbacksOnInit, !1, !0),
        Wr.params.loop && Wr.loopCreate(),
        Wr.attachEvents();
        const Yr = [...Wr.el.querySelectorAll('[loading="lazy"]')];
        return Wr.isElement && Yr.push(...Wr.hostEl.querySelectorAll('[loading="lazy"]')),
        Yr.forEach(Qr => {
            Qr.complete ? processLazyPreloader(Wr, Qr) : Qr.addEventListener("load", Jr => {
    ...
    destroy(Gr, Wr) {
        ...
        return typeof Kr.params > "u" || Kr.destroyed || (Kr.emit("beforeDestroy"),
        Kr.initialized = !1,
        Kr.detachEvents(),
        ...
        Zr && Zr.length && Zr.forEach(ei => {
            ei.classList.remove(Yr.slideVisibleClass, Yr.slideFullyVisibleClass, Yr.slideActiveClass, Yr.slideNextClass, Yr.slidePrevClass),
        ...
        Gr !== !1 && (Kr.el && typeof Kr.el != "string" && (Kr.el.swiper = null),
        deleteProps(Kr)),
        Kr.destroyed = !0),
        null
    }
    ...
    static use(Gr) {
        return Array.isArray(Gr) ? (Gr.forEach(Wr => Swiper.installModule(Wr)),
        Swiper) : (Swiper.installModule(Gr),
        Swiper)
    }
}
...
function Autoplay(ze) {
    ...
    let Jr, Zr, ei = Qr && Qr.autoplay ? Qr.autoplay.delay : 3e3, ti = Qr && Qr.autoplay ? Qr.autoplay.delay : 3e3, ri, ii = new Date().getTime(), ni, si, li, ui, oi, ai, pi;
    function ci(Si) {
        !Gr || Gr.destroyed || !Gr.wrapperEl || Si.target === Gr.wrapperEl && (Gr.wrapperEl.removeEventListener("transitionend", ci),
        !(pi || Si.detail && Si.detail.bySwiperTouchMove) && di())
    }
    const hi = () => {
        if (Gr.destroyed || !Gr.autoplay.running)
            return;
        Gr.autoplay.paused ? ni = !0 : ni && (ti = ri,
        ni = !1);
      ...
      , fi = () => {
        let Si;
        return Gr.virtual && Gr.params.virtual.enabled ? Si = Gr.slides.filter(Ci => Ci.classList.contains("swiper-slide-active"))[0] : Si = Gr.slides[Gr.activeIndex],
      ...
      , vi = Si => {
        ...
        ei = Gr.params.autoplay.delay,
        ti = Gr.params.autoplay.delay;
        const Ci = fi();
        !Number.isNaN(Ci) && Ci > 0 && typeof Si > "u" && (Ai = Ci,
        ei = Ci,
        ti = Ci),
        ri = Ai;
        const Oi = Gr.params.speed
          , Li = () => {
            !Gr || Gr.destroyed || (Gr.params.autoplay.reverseDirection ? !Gr.isBeginning || Gr.params.loop || Gr.params.rewind ? (Gr.slidePrev(Oi, !0, !0),
            Yr("autoplay")) : Gr.params.autoplay.stopOnLastSlide || (Gr.slideTo(Gr.slides.length - 1, Oi, !0, !0),
            Yr("autoplay")) : !Gr.isEnd || Gr.params.loop || Gr.params.rewind ? (Gr.slideNext(Oi, !0, !0),
            Yr("autoplay")) : Gr.params.autoplay.stopOnLastSlide || (Gr.slideTo(0, Oi, !0, !0),
            Yr("autoplay")),
            Gr.params.cssMode && (ii = new Date().getTime(),
            requestAnimationFrame( () => {
                vi()
            }
            )))
        ...
        ;
        return Ai > 0 ? (clearTimeout(Jr),
        Jr = setTimeout( () => {
            Li()
        }
        , Ai)) : requestAnimationFrame( () => {
            Li()
        }
        ),
        Ai
      ...
      , bi = () => {
        ii = new Date().getTime(),
        Gr.autoplay.running = !0,
        vi(),
        Yr("autoplayStart")
    }
      , yi = () => {
        Gr.autoplay.running = !1,
        clearTimeout(Jr),
        cancelAnimationFrame(Zr),
        Yr("autoplayStop")
    }
      , Ei = (Si, Ai) => {
        ...
        const Ci = () => {
            Yr("autoplayPause"),
            Gr.params.autoplay.waitForTransition ? Gr.wrapperEl.addEventListener("transitionend", ci) : di()
        }
        ;
        if (Gr.autoplay.paused = !0,
        Ai) {
            oi && (ri = Gr.params.autoplay.delay),
            oi = !1,
            Ci();
            return
        }
        ri = (ri || Gr.params.autoplay.delay) - (new Date().getTime() - ii),
        !(Gr.isEnd && ri < 0 && !Gr.params.loop) && (ri < 0 && (ri = 0),
        Ci())
    }
      , di = () => {
        Gr.isEnd && ri < 0 && !Gr.params.loop || Gr.destroyed || !Gr.autoplay.running || (ii = new Date().getTime(),
        ai ? (ai = !1,
        vi(ri)) : vi(),
        Gr.autoplay.paused = !1,
        Yr("autoplayResume"))
    }
      , mi = () => {
        if (Gr.destroyed || !Gr.autoplay.running)
        ...
        Si.visibilityState === "hidden" && (ai = !0,
        Ei(!0)),
        Si.visibilityState === "visible" && di()
    }
      , wi = Si => {
        Si.pointerType === "mouse" && (ai = !0,
        pi = !0,
        !(Gr.animating || Gr.autoplay.paused) && Ei(!0))
    }
      , gi = Si => {
        Si.pointerType === "mouse" && (pi = !1,
        Gr.autoplay.paused && di())
    }
      , Ti = () => {
        Gr.params.autoplay.pauseOnMouseEnter && (Gr.el.addEventListener("pointerenter", wi),
        Gr.el.addEventListener("pointerleave", gi))
    }
      , xi = () => {
        Gr.el && typeof Gr.el != "string" && (Gr.el.removeEventListener("pointerenter", wi),
        Gr.el.removeEventListener("pointerleave", gi))
    }
      , Mi = () => {
    ...
    Kr("touchEnd", () => {
        if (!(Gr.destroyed || !Gr.autoplay.running || !si)) {
            if (clearTimeout(ui),
            clearTimeout(Jr),
            Gr.params.autoplay.disableOnInteraction) {
                li = !1,
                si = !1;
                return
            }
            li && Gr.params.cssMode && di(),
            li = !1,
            si = !1
        }
    }
...
function Thumb(ze) {
    ...
    function Jr() {
        ...
        const ri = ti.clickedIndex
          , ii = ti.clickedSlide;
        if (ii && ii.classList.contains(Gr.params.thumbs.slideThumbActiveClass) || typeof ri > "u" || ri === null)
            return;
        let ni;
        ti.params.loop ? ni = parseInt(ti.clickedSlide.getAttribute("data-swiper-slide-index"), 10) : ni = ri,
        Gr.params.loop ? Gr.slideToLoop(ni) : Gr.slideTo(ni)
    }
    function Zr() {
        ...
        if (ti.swiper instanceof ri)
            ...
            Object.assign(Gr.thumbs.swiper.originalParams, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1
            }),
            Object.assign(Gr.thumbs.swiper.params, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1
            }),
            ...
            Gr.thumbs.swiper = new ri(ii),
            Qr = !0
        }
        return Gr.thumbs.swiper.el.classList.add(Gr.params.thumbs.thumbsContainerClass),
        Gr.thumbs.swiper.on("tap", Jr),
        !0
    }
    function ei(ti) {
        ...
        if (Gr.params.slidesPerView > 1 && !Gr.params.centeredSlides && (ni = Gr.params.slidesPerView),
        ...
        ri.params.loop || ri.params.virtual && ri.params.virtual.enabled)
            ...
            for (let oi = 0; oi < ni; oi += 1)
                ri.slides[Gr.realIndex + oi] && ri.slides[Gr.realIndex + oi].classList.add(si);
        ...
        if (Gr.realIndex !== ri.realIndex || ui) {
            ...
            if (ri.params.loop) {
                ...
                ai = ri.slides.indexOf(ci),
                pi = Gr.activeIndex > Gr.previousIndex ? "next" : "prev"
            } else
                ai = Gr.realIndex,
                pi = ai > Gr.previousIndex ? "next" : "prev";
            ui && (ai += pi === "next" ? li : -1 * li),
            ri.visibleSlidesIndexes && ri.visibleSlidesIndexes.indexOf(ai) < 0 && (ri.params.centeredSlides ? ai > oi ? ai = ai - Math.floor(ii / 2) + 1 : ai = ai + Math.floor(ii / 2) - 1 : ai > oi && ri.params.slidesPerGroup,
            ri.slideTo(ai, ti ? 0 : void 0))
        }
    }
    Kr("beforeInit", () => {
        const {thumbs: ti} = Gr.params;
                  ...
                  , ii = () => {
                    ...
                    if (si && si.swiper)
                        ...
                        const li = `${Gr.params.eventsPrefix}init`
                          , ui = oi => {
                            ti.swiper = oi.detail[0],
                            si.removeEventListener(li, ui),
                            Zr(),
                            ei(!0),
                            ti.swiper.update(),
                            Gr.update()
...
class Animate {
    ...
    advance(Gr) {
        ...
        if (this.duration && this.easing) {
            ...
            this.lerp ? (this.value = function(Qr, Jr, Zr, ei) {
            ...
            Kr = !0)) : (this.value = this.to,
            Kr = !0);
        Kr && this.stop(),
        (Wr = this.onUpdate) === null || Wr === void 0 || Wr.call(this, this.value, Kr)
    }
    stop() {
        this.isRunning = !1
    }
    fromTo(Gr, Wr, {lerp: Kr, duration: Yr, easing: Qr, onStart: Jr, onUpdate: Zr}) {
        this.from = this.value = Gr,
        this.to = Wr,
        this.lerp = Kr,
        this.duration = Yr,
        this.easing = Qr,
...
class Dimensions {
    constructor(Gr, Wr, {autoResize: Kr=!0, debounce: Yr=250}={}) {
        ...
        ,
        Kr && (this.debouncedResize = function(Jr, Zr) {
            let ei;
            return function(...ti) {
                let ri = this;
                clearTimeout(ei),
...
class Emitter {
    ...
    emit(Gr, ...Wr) {
        ...
        for (let Qr = 0, Jr = Yr.length; Qr < Jr; Qr++)
            (Kr = Yr[Qr]) === null || Kr === void 0 || Kr.call(Yr, ...Wr)
    }
    on(Gr, Wr) {
        var Kr;
        return !((Kr = this.events[Gr]) === null || Kr === void 0) && Kr.push(Wr) || (this.events[Gr] = [Wr]),
        () => {
            var Yr;
...
class VirtualScroll {
    constructor(Gr, Wr={
        ...
        this.onTouchStart = Kr => {
            ...
            this.touchStart.x = Yr,
            this.touchStart.y = Qr,
            this.lastDelta = {
                x: 0,
                y: 0
            },
...
class Lenis {
    constructor({wrapper: Gr=window, content: Wr=document.documentElement, eventsTarget: Kr=Gr, smoothWheel: Yr=!0, syncTouch: Qr=!1, syncTouchLerp: Jr=.075, touchInertiaMultiplier: Zr=35, duration: ei, easing: ti=hi => Math.min(1, 1.001 - Math.pow(2, -10 * hi)), lerp: ri=.1, infinite: ii=!1, orientation: ni="vertical", gestureOrientation: si="vertical", touchMultiplier: li=1, wheelMultiplier: ui=1, autoResize: oi=!0, prevent: ai, virtualScroll: pi, __experimental__naiveDimensions: ci=!1}={}) {
        this._isScrolling = !1,
        this._isStopped = !1,
        this._isLocked = !1,
        ...
        this.onVirtualScroll = hi => {
            if (typeof this.options.virtualScroll == "function" && this.options.virtualScroll(hi) === !1)
                return;
            ...
            if (this.isTouching = bi.type === "touchstart" || bi.type === "touchmove",
            this.options.syncTouch && yi && bi.type === "touchstart" && !this.isStopped && !this.isLocked)
            ...
            if (wi.find(_i => {
                var Si, Ai, Ci, Oi, Li;
                return _i instanceof HTMLElement && (typeof gi == "function" && (gi == null ? void 0 : gi(_i)) || ((Si = _i.hasAttribute) === null || Si === void 0 ? void 0 : Si.call(_i, "data-lenis-prevent")) || yi && ((Ai = _i.hasAttribute) === null || Ai === void 0 ? void 0 : Ai.call(_i, "data-lenis-prevent-touch")) || Ei && ((Ci = _i.hasAttribute) === null || Ci === void 0 ? void 0 : Ci.call(_i, "data-lenis-prevent-wheel")) || ((Oi = _i.classList) === null || Oi === void 0 ? void 0 : Oi.contains("lenis")) && !(!((Li = _i.classList) === null || Li === void 0) && Li.contains("lenis-stopped")))
            }
            ))
                return;
            if (this.isStopped || this.isLocked)
                return void bi.preventDefault();
            if (!(this.options.syncTouch && yi || this.options.smoothWheel && Ei))
            ...
            this.scrollTo(this.targetScroll + Ti, Object.assign({
                programmatic: !1
            }, xi ? {
                lerp: Mi ? this.options.syncTouchLerp : 1
            } : {
        ...
        this.dimensions = new Dimensions(Gr,Wr,{
            autoResize: oi
        }),
        ...
        this.virtualScroll = new VirtualScroll(Kr,{
            touchMultiplier: li,
            wheelMultiplier: ui
        }),
    ...
    raf(Gr) {
        ...
        this.time = Gr,
        this.animate.advance(.001 * Wr)
    }
    scrollTo(Gr, {offset: Wr=0, immediate: Kr=!1, lock: Yr=!1, duration: Qr=this.options.duration, easing: Jr=this.options.easing, lerp: Zr=this.options.lerp, onStart: ei, onComplete: ti, force: ri=!1, programmatic: ii=!0, userData: ni}={}) {
        if (!this.isStopped && !this.isLocked || ri) {
            if (typeof Gr == "string" && ["top", "left", "start"].includes(Gr))
                Gr = 0;
            else if (typeof Gr == "string" && ["bottom", "right", "end"].includes(Gr))
                Gr = this.limit;
            else {
                let si;
                if (typeof Gr == "string" ? si = document.querySelector(Gr) : Gr instanceof HTMLElement && (Gr != null && Gr.nodeType) && (si = Gr),
                si) {
            ...
            if (typeof Gr == "number") {
                if (Gr += Wr,
                Gr = Math.round(Gr),
                this.options.infinite ? ii && (this.targetScroll = this.animatedScroll = this.scroll) : Gr = clamp(0, Gr, this.limit),
                Gr === this.targetScroll)
                    return ei == null || ei(this),
                    void (ti == null || ti(this));
                if (this.userData = ni ?? {},
                Kr)
                    return this.animatedScroll = this.targetScroll = Gr,
    ...
    get scroll() {
        return this.options.infinite ? function(Wr, Kr) {
            return (Wr % Kr + Kr) % Kr
    ...
    set isScrolling(Gr) {
        this._isScrolling !== Gr && (this._isScrolling = Gr,
        this.updateClassName())
    }
    get isStopped() {
    ...
    set isStopped(Gr) {
        this._isStopped !== Gr && (this._isStopped = Gr,
        this.updateClassName())
    }
    get isLocked() {
    ...
    set isLocked(Gr) {
        this._isLocked !== Gr && (this._isLocked = Gr,
        this.updateClassName())
    }
    get isSmooth() {
    ...
    get className() {
        let Gr = "lenis";
        return this.isStopped && (Gr += " lenis-stopped"),
        this.isLocked && (Gr += " lenis-locked"),
        this.isScrolling && (Gr += " lenis-scrolling"),
        this.isScrolling === "smooth" && (Gr += " lenis-smooth"),
        Gr
    }
    updateClassName() {
        this.cleanUpClassName(),
...
document.addEventListener("alpine:init", () => {
    ...
    Alpine.data("product", () => ({
        ...
        init() {
            ...
            window.location.hash && (this.activeTab = window.location.hash.replace("#", ""))
        }
    }))
}
);
...
function animateTypingWords() {
    document.querySelectorAll(".typing-words").forEach(ze => {
        ...
        let Wr = 0
          ...
          , Jr = 2e3;
        const Zr = () => {
            Kr < Gr[Wr].length ? (ze.innerHTML = Gr[Wr].slice(0, Kr + 1),
            ze.dataset.text = Gr[Wr].slice(0, Kr + 1),
            Kr += Yr,
            setTimeout(Zr, Qr)) : setTimeout(ei, Jr)
        }
          , ei = () => {
            Kr > 0 ? (ze.innerHTML = Gr[Wr].slice(0, Kr - 1),
            ze.dataset.text = Gr[Wr].slice(0, Kr - 1),
            Kr -= Yr,
            setTimeout(ei, Qr)) : (Wr = (Wr + 1) % Gr.length,
            setTimeout(Zr, 500))
        }
        ;
        setTimeout(ei, 500)
